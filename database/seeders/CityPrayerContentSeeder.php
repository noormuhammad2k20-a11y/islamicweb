...
'jummah_note' => "Faisal Mosque in Islamabad hosts the largest Jummah congregation in the city. The Pakistan government\'s official religious affairs department announces moon sighting from Islamabad.",

'special_note' => "Prayer timings in Islamabad Hanafi madhab are officially published by the Ministry of Religious Affairs. Islamabad and Rawalpindi prayer times are virtually identical.",
...
'article_en' => "Multan, known as the \"City of Saints\" (Madinat-ul-Awliya), is one of Pakistan\'s most spiritually significant cities with a rich Sufi heritage. Prayer time in Multan follows the Karachi calculation method. Located at 30.1575°N, 71.5249°E in southern Punjab, Multan\'s prayer times are calculated precisely for its coordinates. The city is home to numerous shrines of Islamic saints, including Bahauddin Zakariya and Shah Rukn-e-Alam, where thousands of devotees visit daily. Fajr prayer time in Multan is observed in the peaceful pre-dawn hours. Asr prayer time Multan Hanafi is the afternoon prayer. The famous Shah Rukn-e-Alam shrine mosque is a major Islamic landmark. Multan\'s extreme summer heat makes the Zuhr prayer an important midday observance. Namaz timing in Multan today is followed by the city\'s large Muslim population. Maghrib prayer in Multan arrives at sunset. Isha time in Multan completes the evening prayers. The city has a strong Barelvi and Sufi tradition with numerous Dargahs (shrines) that function as important Islamic centers. Multan has been an Islamic city since the Arab conquest in 712 CE, making it one of South Asia\'s oldest Muslim cities.",

'famous_mosques' => json_encode(["Shah Rukn-e-Alam Shrine Mosque","Bahauddin Zakariya Shrine Mosque","Masjid Mustafa Multan","Eid Gah Multan","Jamia Masjid Multan"]),

'islamic_history' => "Multan was conquered by Muhammad bin Qasim in 712 CE, making it one of the first cities in South Asia to embrace Islam. The city became a major center of Sufi saints and Islamic scholarship. Saints like Bahauddin Zakariya and Shah Shams Tabrez are buried here.",

'jummah_note' => "Jummah prayer in Multan attracts large congregations at the city\'s historic mosques and shrine complexes.",

'special_note' => "Multan is called City of Saints (Madinat-ul-Awliya). The shrine complexes serve as important Islamic gathering centers.",

],

[

'city_slug' => "gujranwala",
...
'article_en' => "Sheikhupura, an industrial city near Lahore in Punjab, has significant Mughal era historical heritage and a strong Muslim population. Prayer time in Sheikhupura follows the Karachi calculation method. Located at 31.7167°N, 73.9850°E close to Lahore, Sheikhupura\'s prayer times are very similar to Lahore with minor differences. The city\'s Hiran Minar, a Mughal-era monument, reflects its Islamic architectural heritage. Fajr prayer time in Sheikhupura marks the dawn prayer. Asr prayer time Sheikhupura Hanafi is the afternoon prayer. Zuhr prayer arrives at solar noon. Maghrib prayer comes at sunset. The city\'s industrial workers observe prayer breaks. Namaz timing in Sheikhupura today is followed by all Muslims in the city.",

'famous_mosques' => json_encode(["Jamia Masjid Sheikhupura","Hiran Minar area Masjid","Masjid Bilal Sheikhupura","Central Mosque Sheikhupura","Eid Gah Sheikhupura"]),

'islamic_history' => "Sheikhupura has Mughal-era historical significance. The famous Hiran Minar was built by Emperor Jahangir in memory of his pet deer. The area has been Muslim-majority since the Mughal period.",

'jummah_note' => "Jummah prayers in Sheikhupura are observed at city mosques.",

'special_note' => "Sheikhupura is close to Lahore and shares nearly identical prayer times.",
...
'article_en' => "Rahim Yar Khan, located in the southernmost part of Punjab near the Sindh border, is an agricultural city on the Indus plains. Prayer time in Rahim Yar Khan follows the Karachi calculation method. Situated at 28.4202°N, 70.2952°E, its southern location means slightly different prayer times compared to Lahore. Fajr prayer time in Rahim Yar Khan begins the day. The city\'s agricultural community — known for cotton and sugarcane farming — observes prayer times between farm activities. Asr prayer time Rahim Yar Khan Hanafi is afternoon prayer. The extreme summer heat of this southern Punjab city makes Zuhr prayer a crucial midday observance. Maghrib time in Rahim Yar Khan comes at sunset. Namaz timing in Rahim Yar Khan is followed by the local Muslim population. Isha prayer completes the evening.",

'famous_mosques' => json_encode(["Jamia Masjid Rahim Yar Khan","Central Mosque RYK","Masjid-e-Noor RYK","Eid Gah Rahim Yar Khan","Khanpur Dam Mosque"]),

'islamic_history' => "Rahim Yar Khan is named after a local Muslim ruler. The area is part of the ancient Indus civilization region that converted to Islam in the medieval period.",

'jummah_note' => "Jummah prayers in Rahim Yar Khan are held at mosques throughout the city.",

'special_note' => "Rahim Yar Khan is abbreviated as RYK in Pakistan. It borders Sindh province.",
...
'article_en' => "Okara, an agricultural district in central Punjab, is known for its dairy farms and agricultural productivity. Prayer time in Okara follows the Karachi calculation method. Located at 30.8092°N, 73.4453°E in Punjab, Okara\'s prayer times fall between Lahore and Multan. The city has a strong Muslim farming community that observes prayer times faithfully. Fajr prayer time in Okara starts the day. Asr prayer time Okara Hanafi is afternoon prayer. Zuhr time in Okara arrives at midday. Maghrib prayer comes at sunset. The military cantonment in Okara has its own mosque facilities. Namaz timing in Okara is followed by the local community. Isha prayer completes the day.",

'famous_mosques' => json_encode(["Central Mosque Okara","Okara Cantt Mosque","Jamia Masjid Okara","Eid Gah Okara","Masjid-e-Ibrahim Okara"]),

'islamic_history' => "Okara was established as a town in 1892 during British rule. Its agricultural lands have been farmed by Muslim families for generations.",

'jummah_note' => "Friday prayers in Okara are observed at city mosques.",

'special_note' => "Okara is known for its dairy farming. Okara Military Farms are famous across Pakistan.",
...
'article_en' => "Dubai, the global city and commercial capital of the UAE, is home to over 3.5 million residents from more than 200 nationalities, with Muslims forming a significant portion. Prayer time in Dubai follows the UAE Awqaf (General Authority of Islamic Affairs and Endowments — UAQF) calculation, which uses the astronomical method approved for the UAE. Dubai prayer times are published daily by Khaleej Times newspaper and the official UAQF app. Fajr prayer time in Dubai is observed before sunrise when the sky shows the first light. The Dubai Khaleej Times prayer times are widely referenced across the emirate. Asr prayer time in Dubai uses the Shafi madhab as the default UAE calculation, though Hanafi Asr time is also observed by South Asian expatriates. The iconic Dubai Mosque and Jumeirah Mosque are landmarks that attract visitors worldwide. Maghrib prayer time in Dubai coincides with sunset over the Arabian Gulf. Jummah prayer time in Dubai draws thousands to major mosques. Eid prayer time in Dubai is announced officially by the UAE government. Isha prayer time in Dubai completes the night prayer cycle. The Dubai Department of Islamic Affairs (IACAD) regulates mosque activities and prayer times. Awqaf prayer time Dubai follows the official UAE Islamic calendar.",

'famous_mosques' => json_encode(["Jumeirah Mosque","Grand Mosque Dubai (Al Farooq Omar Bin Al Khattab Mosque)","Dubai Frame Mosque","Eid Gah Dubai","Ibn Battuta Mall Mosque"]),

'islamic_history' => "Dubai has ancient Islamic heritage. The Al Fahidi Historical Neighbourhood preserves the old Dubai. The Dubai Museum showcases the emirate\'s history. Dubai\'s transformation from a fishing village to a global city happened within living memory, but its Islamic identity remains central to its character.",

'jummah_note' => "Jummah prayer time in Dubai is at Zuhr time. Major mosques including Jumeirah Mosque and Al Farooq Mosque host thousands of worshippers. Dubai Khaleej Times publishes Jummah prayer times.",

'eid_prayer_note' => "Eid prayer time in Dubai is announced by the UAE government 1 day before Eid. Prayers are held at major mosques and open-air Eid Gah areas. Eid al-Adha prayer time in Dubai is typically 6:00-7:00 AM.",

'special_note' => "Dubai prayer times are published by Khaleej Times daily. The UAQF (UAE Awqaf) calculation method is used. Awqaf prayer time Dubai is the official source.",

'calculation_note' => "Dubai uses the UAE UAQF calculation method. This differs from the Karachi method. South Asian expatriates may follow Hanafi Asr time which is 30-40 minutes later than the standard UAE Asr.",
...
'article_en' => "Sharjah, the third-largest emirate and UAE\'s Cultural Capital, is known for its strong Islamic values and strict adherence to Islamic principles. Prayer time in Sharjah follows the UAE Awqaf official calculation. Sharjah is unique among UAE emirates for its strict Islamic laws — the sale of alcohol is prohibited and the emirate emphasizes Islamic culture. Fajr prayer time in Sharjah is observed before sunrise. The King Faisal Mosque in Sharjah is one of the UAE\'s most beautiful mosques. Asr prayer time in Sharjah follows the UAE standard calculation. Jummah prayer time in Sharjah draws large congregations. The Sharjah Department of Islamic Affairs organizes regular Islamic events. Isha prayer time in Sharjah completes the night prayer. Today prayer time Sharjah is published by the UAE Awqaf. Sharjah Jummah prayer time today is at Zuhr time. The emirate\'s Islamic Museum and Heritage Area are major educational centers.",

'famous_mosques' => json_encode(["King Faisal Mosque Sharjah","Al Noor Mosque Sharjah","Masjid al-Khalid Sharjah","Al Khan Mosque Sharjah","Eid Gah Sharjah"]),

'islamic_history' => "Sharjah has maintained strong Islamic values and is known as the Cultural Capital of the UAE. The emirate has invested heavily in Islamic heritage, museums, and education. Sharjah has won multiple UNESCO awards for its cultural preservation.",

'jummah_note' => "Sharjah Jummah prayer time is at Zuhr time. Sharjah has a strong culture of Friday prayers with mosques filled across the emirate. Sharjah Friday prayer time today is officially published.",

'eid_prayer_note' => "Eid prayer time in Sharjah follows UAE official announcement. Major mosques and open areas host Eid prayers.",

'special_note' => "Sharjah prohibits alcohol and has strict Islamic laws. Prayer times in Sharjah follow UAE Awqaf official calculation.",
...
'article_en' => "Ajman, the smallest of the seven UAE emirates, is a compact city with a strong Muslim community and growing population. Prayer time in Ajman follows the UAE Awqaf official calculation. Located adjacent to Sharjah, Ajman prayer times are nearly identical to Sharjah prayer times. Fajr prayer time in Ajman is observed before sunrise. Asr prayer time in Ajman follows UAE standard calculation. The Ajman Mosque and other local mosques serve the emirate\'s Muslim population. Jummah prayer time in Ajman is at Zuhr time. Eid prayer time in Ajman follows UAE government announcement. Isha prayer time Ajman completes the night. Today prayer time Ajman today is published by UAE Awqaf. Ajman prayer time today follows official UAE calculation.",

'famous_mosques' => json_encode(["Ajman Mosque","Sheikh Humaid Bin Rashid Mosque Ajman","Al Rashidiya Mosque Ajman","Masjid al-Farooq Ajman","Eid Gah Ajman"]),

'islamic_history' => "Ajman is one of the original seven emirates of the UAE. The Al Zorah area of Ajman preserves Emirati heritage. The Ajman Museum is located in a historic fort.",

'jummah_note' => "Jummah prayer time in Ajman is at Zuhr time. Ajman prayer time today for Friday follows official UAE times.",

'eid_prayer_note' => "Eid prayer time Ajman follows UAE government official announcement.",

'special_note' => "Ajman prayer times are nearly identical to Sharjah due to their adjacent location.",
...
'article_en' => "Makkah (Mecca), the holiest city in Islam and birthplace of Prophet Muhammad (PBUH), draws millions of pilgrims from around the world every year for Hajj and Umrah. Prayer time in Makkah is the reference point for Muslims worldwide. Makkah prayer times are led by the Imam of Masjid al-Haram, the Grand Mosque that surrounds the Kaaba. Fajr prayer time in Makkah begins the day before sunrise in the holy city. The Azan from Makkah\'s minarets is broadcast worldwide and millions of Muslims listen to it daily. Makkah prayer time today follows the Umm al-Qura University calculation used across Saudi Arabia. The Masjid al-Haram (Grand Mosque of Makkah) can accommodate up to 2.5 million worshippers simultaneously. Asr prayer time in Makkah follows Shafi madhab as per Saudi Arabia\'s official calculation. Zuhr prayer time in Makkah falls at solar noon. During Hajj, prayer times in Makkah are observed at Mina, Arafat, and Muzdalifah according to the same schedule. Maghrib prayer in Makkah — when the sun sets over the Kaaba — is one of the most spiritually significant moments in Islam. Haram prayer time is broadcast worldwide. Isha prayer time in Makkah completes the night prayer behind the Imam of the Haram.",

'famous_mosques' => json_encode(["Masjid al-Haram (Grand Mosque)","Masjid al-Tan\'eem (Masjid Aisha)","Masjid al-Khayf (Mina)","Masjid al-Jinn","Masjid al-Ijabah"]),

'islamic_history' => "Makkah is Islam\'s holiest city. The Kaaba, built by Prophet Ibrahim and his son Ismail (PBUH), is the direction of prayer for all Muslims. Prophet Muhammad (PBUH) was born here in 570 CE. The city was conquered by Muslims in 630 CE (Fatah Makkah). No non-Muslim is permitted to enter Makkah.",

'jummah_note' => "Jummah prayer at Masjid al-Haram in Makkah is led by the Grand Imam of the Haram and broadcast globally. This is considered the most blessed Jummah prayer in the world.",

'eid_prayer_note' => "Eid prayer in Makkah is performed at Masjid al-Haram. Eid is announced by the Saudi Supreme Court based on moon sighting.",

'special_note' => "Makkah prayer times are the spiritual reference for the entire Muslim world. Haram prayer time Makkah is broadcast live globally. Masjid al-Haram prayer times are published by Saudi Arabia\'s Ministry of Islamic Affairs.",

'calculation_note' => "Makkah prayer times use the Umm al-Qura University calculation, the official Saudi Arabia method.",
...
'article_en' => "Madinah (Medina), the City of the Prophet and second holiest city in Islam, is where Prophet Muhammad (PBUH) established the first Islamic state and where his blessed tomb is located. Prayer time in Madinah follows the Umm al-Qura calculation used across Saudi Arabia. Madinah prayer times are led by the Imam of Masjid al-Nabawi (Prophet\'s Mosque). Fajr prayer time in Madinah is observed in the most blessed atmosphere of the Prophet\'s city. The Masjid al-Nabawi (Prophet\'s Mosque), originally built by Prophet Muhammad (PBUH) himself, has been expanded multiple times and can now accommodate up to 1 million worshippers. Masjid Nabawi prayer times are broadcast worldwide and observed with great devotion. Asr prayer time in Madinah follows Saudi Arabia\'s official calculation. Zuhr prayer at the Prophet\'s Mosque is led by the Imam of Masjid Nabawi. Maghrib prayer time in Madinah marks the end of the fasting day during Ramadan. Prayer in Masjid al-Nabawi is equivalent to 1,000 prayers elsewhere according to Hadith. Medina prayer times today use the Umm al-Qura calculation. Isha prayer in Madinah is followed by Tahajjud prayers throughout the night in this blessed city.",

'famous_mosques' => json_encode(["Masjid al-Nabawi (Prophet\'s Mosque)","Masjid Quba","Masjid al-Qiblatayn","Masjid al-Jumua","Masjid al-Miqat"]),

'islamic_history' => "Madinah was the destination of the Hijra (migration) of Prophet Muhammad (PBUH) in 622 CE, marking Year 1 of the Islamic calendar. The city is home to the Prophet\'s Mosque and his blessed tomb. Masjid Quba, also in Madinah, was the first mosque built in Islamic history.",

'jummah_note' => "Jummah prayer at Masjid al-Nabawi is led by the Imam of the Prophet\'s Mosque and is one of the most sought-after religious experiences. Prayer in Masjid al-Nabawi on Friday equals 1,000 ordinary Jummah prayers according to Islamic scholars.",

'eid_prayer_note' => "Eid prayers in Madinah are held at Masjid al-Nabawi and Eid Gah areas. Eid is announced per Saudi Arabia\'s official moon sighting.",

'special_note' => "Madinah prayer times are published by the Saudi Ministry of Islamic Affairs. Masjid Nabawi prayer times are broadcast globally. Prayer in Masjid al-Nabawi carries special spiritual rewards.",

'calculation_note' => "Madinah uses the Umm al-Qura University calculation method — the official Saudi Arabia standard.",
...
'article_en' => "Riyadh, the capital of Saudi Arabia and one of the world\'s largest cities, is the political and administrative heart of the Kingdom. Prayer time in Riyadh is strictly observed throughout the city, with shops and businesses required to close during prayer times by law. Riyadh prayer times follow the Umm al-Qura University calculation, Saudi Arabia\'s official method. Fajr prayer time in Riyadh begins the day before sunrise. Today prayer time in Riyadh is published by the Saudi Ministry of Islamic Affairs and widely referenced. The King Khalid Grand Mosque and Al Rajhi Mosque are among Riyadh\'s most prominent mosques. Asr prayer time in Riyadh follows the Saudi Shafi-based calculation. Zuhr prayer time in Riyadh falls at solar noon. During prayer times in Riyadh, the Hay\'a (religious police, now reformed) enforced closure of shops — a tradition still observed voluntarily by many businesses. Maghrib prayer time in Riyadh marks the end of the fast during Ramadan. Jummah prayer time Riyadh is observed with shops closing. Isha prayer time in Riyadh completes the night.",

'famous_mosques' => json_encode(["King Khalid Grand Mosque Riyadh","Al Rajhi Mosque Riyadh","Imam Turki bin Abdullah Grand Mosque","King Fahd Mosque Riyadh","Masjid al-Ansar Riyadh"]),

'islamic_history' => "Riyadh was the capital of the First Saudi State established by Muhammad bin Saud and Muhammad ibn Abd al-Wahhab in 1744. The Diriyah area, near Riyadh, is the birthplace of the Saudi state and a UNESCO World Heritage Site.",

'jummah_note' => "Jummah prayer time Riyadh is a significant event. Shops close and businesses shut during Friday prayers in Riyadh. Jummah prayer time riyadh today follows the official Saudi schedule.",

'eid_prayer_note' => "Eid prayer time in Riyadh is announced by the Saudi Supreme Court. Open prayer grounds (Musalla) across Riyadh host Eid prayers.",

'special_note' => "Prayer time Riyadh today is strictly observed. Saudi Arabia law requires businesses to close during prayer times. Today prayer time in Riyadh is widely referenced by South Asian expats.",

'calculation_note' => "Riyadh uses Umm al-Qura University calculation method.",
...
'article_en' => "Jeddah, Saudi Arabia\'s commercial capital and gateway city for Hajj and Umrah pilgrims, is a cosmopolitan city on the Red Sea coast. Prayer time in Jeddah follows the Umm al-Qura calculation. Jeddah prayer times today are widely followed by Saudi nationals and the large expatriate community. Fajr prayer time in Jeddah begins before sunrise over the Red Sea. The city\'s historic Al-Balad neighborhood (a UNESCO World Heritage Site) has centuries-old mosques. The Floating Mosque (Mosque of the Open Sea) in Jeddah is an iconic landmark that appears to float on the Red Sea. Asr prayer time in Jeddah follows Saudi calculation. Zuhr prayer time in Jeddah falls at solar noon. The King Fahd Fountain — world\'s tallest fountain — stands near several prominent mosques. Today prayer time jeddah is published by Saudi authorities. Maghrib prayer time in Jeddah marks sunset over the Red Sea. Juma prayer time Jeddah is observed weekly. Isha prayer time in Jeddah completes the night.",

'famous_mosques' => json_encode(["Al-Shafi\'i Mosque Jeddah (oldest)","Floating Mosque (Masjid al-Rahma)","King Fahd Mosque Jeddah","Qishla Mosque (Al-Balad)","Masjid Bilal Jeddah"]),

'islamic_history' => "Jeddah has been an important Islamic city and gateway for Hajj pilgrims for over 1,400 years. The historic Al-Balad district with its coral-stone buildings is a UNESCO World Heritage Site. Eve\'s Tomb (Hawwa) is traditionally said to be located in Jeddah.",

'jummah_note' => "Jummah prayer time Jeddah is observed weekly. The city\'s large mosques host thousands for Friday prayers. Juma prayer time in jeddah today follows official Saudi schedule.",

'eid_prayer_note' => "Eid prayer time in Jeddah follows Saudi government announcement. Open musallas and major mosques host Eid prayers.",

'special_note' => "Jeddah is the gateway city for Umrah pilgrims. Today prayer time jeddah is widely referenced by millions of pilgrims passing through.",
...
'article_en' => "Dammam, the capital of Saudi Arabia\'s Eastern Province and center of the Kingdom\'s oil industry, is a modern city with a strong Islamic community. Prayer time in Dammam follows the Umm al-Qura University calculation used across Saudi Arabia. Located on the Arabian Gulf coast, Dammam prayer times are similar to Khobar and Jubail. Fajr prayer time in Dammam is observed before sunrise over the Gulf. The city\'s prosperity from oil wealth has funded the construction of many magnificent mosques. Asr prayer time in Dammam follows Saudi calculation. Today prayer time in Dammam is published by Saudi authorities. Zuhr prayer at midday in Dammam. Maghrib prayer time Dammam today marks sunset over the Arabian Gulf. Prayer time Dammam today is widely followed by the large Pakistani, Indian, and other South Asian expatriate communities working in the oil industry. Jummah prayer time in Dammam is a significant weekly event. Isha prayer time in Dammam completes the night. Prayer time in Dammam today follows official Saudi schedule.",

'famous_mosques' => json_encode(["Al Ameer Mosque Dammam","Masjid al-Jafali Dammam","King Fahd Mosque Dammam","Al Faisaliyah Mosque Dammam","Eid Gah Dammam"]),

'islamic_history' => "Dammam grew rapidly after the discovery of oil in 1938. The Eastern Province has significant Islamic heritage with ancient Muslim settlements along the Gulf coast.",

'jummah_note' => "Jummah prayer in Dammam is observed at major mosques. The large South Asian expatriate community follows the official Saudi prayer times.",

'eid_prayer_note' => "Eid prayer time in Dammam follows Saudi government announcement. Major mosques and open musallas host Eid prayers.",

'special_note' => "Dammam is the center of Saudi Arabia\'s oil industry. Today prayer time Dammam is followed by thousands of Pakistani and Indian expats.",
