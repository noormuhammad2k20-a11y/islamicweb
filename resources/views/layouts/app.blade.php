...
<head>
    ...
    {{-- Urdu font preload --}}
    @if(file_exists(public_path('fonts/urdu-font.woff2')))
    <link rel="preload" href="{{ asset('fonts/urdu-font.woff2') }}" as="font" type="font/woff2" crossorigin>
    @endif
    
    @if(file_exists(public_path('fonts/JameelNooriNastaleeq.woff2')))
    <link rel="preload" href="{{ asset('fonts/JameelNooriNastaleeq.woff2') }}" as="font" type="font/woff2" crossorigin>
    @endif
    ...
    <nav class="navbar" id="navbar">
        <div class="navbar-inner">
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="{{ route('quiz.index') }}" class="{{ request()->routeIs('quiz.*') ? 'active' : '' }}"><i class="fas fa-clipboard-question"></i> Quiz</a></li>
