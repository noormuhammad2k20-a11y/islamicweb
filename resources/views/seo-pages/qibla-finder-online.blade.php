...
<div class="container" style="max-width: 1000px; margin: 50px auto; padding: 0 20px;">
    ...
    <div style="background: white; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); padding: 50px; margin-bottom: 40px; text-align: center;">
        ...
        <a href="{{ route('tools.qibla') }}" style="display: inline-block; padding: 15px 35px; background: linear-gradient(145deg, var(--navy), var(--navy-mid)); color: white; border-radius: 30px; text-decoration: none; font-weight: bold; font-size: 1.1rem; box-shadow: 0 4px 15px rgba(10,31,63,0.2);">
