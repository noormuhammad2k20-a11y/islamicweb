...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "The Iftar time today starts precisely at {{ $prayers['maghrib'] }}."
    }
  }, {
    "@@type": "Question",
...
<div class="page-header text-center" style="padding: 60px 20px; background: var(--bg-tinted); border-bottom: 1px solid var(--border-light);">
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <p style="font-size: 1.1rem; color: var(--text-medium); line-height: 1.6;">Today's Iftar (Fast Breaking) time for <strong>{{ $date->format('d F Y') }}</strong> ({{ $hijri['day'] }} {{ $hijri['month_name'] }} {{ $hijri['year'] }} AH).</p>
    </div>
</div>
