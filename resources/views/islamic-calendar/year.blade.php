...
<section class="section-container">
    <div class="hijri-span-card">
        ...
        <div style="color: #666; margin-top: 8px;">January {{ $year }}: {{ $startHijri['formatted'] }} — December {{ $year }}: {{ $endHijri['formatted'] }}</div>
    </div>
</section>
...
<section class="section-container">
    <div class="internal-links">
        ...
        @if($year < 2030)<a href="{{ route('islamic-calendar-year', $year + 1) }}" class="internal-link">{{ $year + 1 }} →</a>@endif
    </div>
</section>
