...
<section class="section-container">
    <div class="controls-bar">
        <form method="GET" action="{{ route('islamic-calendar') }}" style="display: flex; gap: 12px; flex-wrap: wrap; justify-content: center;">
            ...
            <div class="event-card">
                ...
                <div>
                    ...
                    @if($event->event_name_urdu)
                        <div style="font-family: 'Amiri', serif; color: var(--gold); font-size: 0.9rem;">{{ $event->event_name_urdu }}</div>
                    @endif
                </div>
            </div>
        @endforeach
