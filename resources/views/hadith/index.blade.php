    ...
    <div class="section-inner">
        ...
        <div class="topics-grid">
            ...
            <div class="topic-card-wrapper">
                <a href="{{ route('hadith.show', $topic->slug) }}" style="text-decoration: none; color: inherit; display: block; height: 100%;">
        ...
        <div style="max-width: 800px; margin: 0 auto;">
            ...
            <div class="hadith-card">
                ...
                <div class="hadith-reference">
                    ...
                    <a href="{{ route('hadith.show', $fhadith->topic->slug) }}" style="color: var(--navy); font-weight: 600; margin-left: auto; text-decoration: none; display: inline-flex; align-items: center; gap: 8px;">Read More <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
            @endforeach
        </div>
