...
@section('title', 'Ramadan Calendar — Noor-e-Islam')
@section('meta_description', 'Local city-based schedule and countdown')

@section('content')
<section class="section" style="padding-top: 60px; padding-bottom: 60px;">
    <div class="section-inner">
        <x-page-header title="Ramadan Calendar" desc="Local city-based schedule and countdown" icon="fa-calendar-alt" />
            ...
            @if(isset($items) && count($items) > 0)
                @foreach($items as $item)
                    <x-module-card 
                        ...
                        icon="{{ $item->icon ?? 'fa-calendar-alt' }}" 
                        url="#" 
