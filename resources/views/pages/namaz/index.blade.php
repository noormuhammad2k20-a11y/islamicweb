...
@section('title', 'Learn Salah — Noor-e-Islam')
@section('meta_description', 'Importance and Pillars of Salah')

@section('content')
<section class="section" style="padding-top: 60px; padding-bottom: 60px;">
    <div class="section-inner">
        <x-page-header title="Learn Salah" desc="Importance and Pillars of Salah" icon="fa-praying-hands" />
            ...
            @if(isset($guides) && count($guides) > 0)
                @foreach($guides as $guide)
                    <x-module-card 
                        ...
                        icon="{{ $guide->icon ?? 'fa-praying-hands' }}" 
                        url="#" 
