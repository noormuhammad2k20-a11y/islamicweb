...
@section('title', isset($seoMeta) ? $seoMeta->title : 'Salat ul Tasbeeh Method, Benefits & Duas | Complete Step-by-Step Guide')
@section('meta_description', isset($seoMeta) ? $seoMeta->description : 'Learn how to perform Salat ul Tasbeeh (Tasbeeh Namaz) with our complete step-by-step guide. Discover the method, benefits, hadith, and exact duas to recite.')
...
<div class="article-container" itemscope itemtype="https://schema.org/Article">
    <div itemprop="articleBody">
        ...
        <a href="{{ route('tasbeeh.counter') }}" class="tasbeeh-cta">
        ...
        <ul>
            <li><strong>Do not count on your fingers:</strong> Moving your fingers to count during Salah can invalidate the prayer (Amal-e-Kaseer). Instead, press your fingers down gently, or use a mental count. If you need a physical counter outside of prayer, use our <a href="{{ route('tasbeeh.counter') }}" style="color: var(--primary); font-weight: bold;">Digital Tasbeeh Counter</a>.</li>
