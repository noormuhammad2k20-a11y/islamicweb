...
@section('title', 'Prayer Guide — Noor-e-Islam')
@section('meta_description', 'Detailed guide for specific prayer')

@section('content')
<section class="section" style="padding-top: 60px; padding-bottom: 60px;">
    <div class="section-inner">
        <x-page-header title="Prayer Guide" desc="Detailed guide for specific prayer" icon="fa-book-open" />
