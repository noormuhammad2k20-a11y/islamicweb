    ...
    <div class="section-inner">
        ...
        <div class="filters-container">
            ...
            <div class="quick-links">
                ...
                <a href="{{ route('names.gender', 'boys') }}" class="quick-link"><i class="fas fa-male" style="color: #0369a1;"></i> Boys</a>
                <a href="{{ route('names.gender', 'girls') }}" class="quick-link"><i class="fas fa-female" style="color: #be185d;"></i> Girls</a>
                <a href="{{ route('names.index', ['filter' => 'quranic']) }}" class="quick-link"><i class="fas fa-quran" style="color: #15803d;"></i> Quranic</a>
                <a href="{{ route('names.index', ['filter' => 'sahabah']) }}" class="quick-link"><i class="fas fa-users" style="color: #6d28d9;"></i> Sahabah</a>
            </div>
