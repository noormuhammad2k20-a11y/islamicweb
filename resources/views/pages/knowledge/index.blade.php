...
@section('title', 'Islamic Knowledge Hub — Learn About Islam')
@section('meta_description', 'Explore the Islamic Knowledge Hub. Learn about the 5 Pillars of Islam, 6 Pillars of Iman, the Prophets, Islamic History, and fascinating facts.')
@section('meta_keywords', 'islamic knowledge, learn islam, pillars of islam, history of islam, prophets in quran, islamic facts')
  ...
  "itemListElement": [
    {
      ...
      "url": "{{ route('knowledge.pillars_islam') }}"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "The 6 Pillars of Iman",
      "url": "{{ route('knowledge.pillars_iman') }}"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Prophets in Islam",
      "url": "{{ route('knowledge.prophets') }}"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Islamic History",
      "url": "{{ route('knowledge.history') }}"
    },
    {
      "@type": "ListItem",
      "position": 5,
      "name": "Islamic Facts",
      "url": "{{ route('knowledge.facts') }}"
    }
  ]
}
</script>
    ...
    <section class="k-grid-section">
        <div class="k-grid-inner">
            <div class="knowledge-grid">
                ...
                <a href="{{ route('knowledge.pillars_islam') }}" class="knowledge-card">
                ...
                <a href="{{ route('knowledge.pillars_iman') }}" class="knowledge-card">
                ...
                <a href="{{ route('knowledge.prophets') }}" class="knowledge-card">
                ...
                <a href="{{ route('knowledge.history') }}" class="knowledge-card">
                ...
                <a href="{{ route('knowledge.facts') }}" class="knowledge-card">
