...
@section('title', 'Prophets in Islam — Messengers of Allah')
@section('meta_description', 'Learn about the 25 Prophets mentioned in the Quran by name, their messages, and their significance in Islam.')
@section('meta_keywords', 'prophets in islam, prophets in quran, 25 prophets in islam, messengers of allah, anbiya in islam, ulul azm')
