        ...
        <div class="quiz-question" id="q{{ $index }}" style="{{ $index > 0 ? 'display: none;' : '' }}">
            <div style="background: #fff; border-radius: 14px; padding: 32px; box-shadow: 0 4px 20px rgba(0,0,0,0.06); border: 1px solid #eee;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <span style="background: linear-gradient(135deg, #1a6b42, #2d9254); color: #fff; padding: 4px 14px; border-radius: 16px; font-size: 0.8rem;">{{ optional($q->category)->name_urdu ?? optional($q->category)->name_english ?? 'عمومی' }}</span>
