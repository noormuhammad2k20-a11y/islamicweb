...
@section('title', '99 Names of Allah (Asma ul Husna) - Meaning & Benefits')
...
<section class="names-section print-section">
    <div class="names-grid">
        ...
        <a href="{{ route('names_allah.show', $name->slug) }}" class="name-card">
            <div class="name-number">
                {{ $name->number }}
            </div>
            
            <button class="copy-btn" onclick="event.preventDefault(); copyName('{{ $name->arabic }} - {{ $name->transliteration }}', this)" title="Copy Name">
