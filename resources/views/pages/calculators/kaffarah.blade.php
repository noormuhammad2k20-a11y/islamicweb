...
@section('title', 'Kaffarah Calculator — Ramadan Fasting Penalty')
@section('meta_description', 'Calculate your Kaffarah (penalty) for deliberately breaking a Ramadan fast. Learn the rules, cost, and alternatives of Kaffarah in Islam.')
@section('meta_keywords', 'kaffarah calculator, kaffarah for broken fast, ramadan kaffarah, cost of kaffarah, kaffarah penalty')
