...
@section('title', 'Islamic Calculators — Zakat, Fidya, Kaffarah & Inheritance')
@section('meta_description', 'Free online Islamic calculators. Calculate your Zakat, Gold/Silver Nisab, Ramadan Fidya, Kaffarah, and Islamic Inheritance accurately according to Shariah.')
@section('meta_keywords', 'islamic calculators, zakat calculator, fidya calculator, kaffarah calculator, inheritance calculator islam, online zakat calculator, islamic tools')
  ...
  "itemListElement": [
    {
      ...
      "url": "{{ route('calculators.zakat') }}"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Fidya Calculator",
      "url": "{{ route('calculators.fidya') }}"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Kaffarah Calculator",
      "url": "{{ route('calculators.kaffarah') }}"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Inheritance Calculator",
      "url": "{{ route('calculators.inheritance') }}"
    }
  ]
}
</script>
    ...
    <section class="c-grid-section">
        <div class="c-grid-inner">
            <div class="calc-grid">
                ...
                <a href="{{ route('zakat.index') }}" class="calc-card">
                ...
                <a href="{{ route('calculators.zakat_gold') }}" class="calc-card gold-card">
                ...
                <a href="{{ route('calculators.zakat_silver') }}" class="calc-card">
                ...
                <a href="{{ route('calculators.fidya') }}" class="calc-card">
                ...
                <a href="{{ route('calculators.kaffarah') }}" class="calc-card">
                ...
                <a href="{{ route('calculators.inheritance') }}" class="calc-card">
