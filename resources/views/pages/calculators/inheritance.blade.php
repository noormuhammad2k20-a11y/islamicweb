...
@section('title', 'Islamic Inheritance Calculator & Mirath Guide')
@section('meta_description', 'Learn the rules of Islamic Inheritance (Mirath) according to the Quran. Discover the fixed shares for heirs and use our guide to understand estate distribution.')
@section('meta_keywords', 'islamic inheritance calculator, mirath in islam, inheritance shares in islam, quran inheritance rules, faraid calculator, who inherits in islam')
