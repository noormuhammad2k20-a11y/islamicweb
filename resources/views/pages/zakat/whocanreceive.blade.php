...
@section('title', 'Who Can Receive Zakat? — The 8 Eligible Categories')
@section('meta_description', 'Discover the 8 categories of people eligible to receive Zakat as outlined in the Quran (Surah At-Tawbah 9:60), including the poor, the needy, and those in debt.')
@section('meta_keywords', 'who can receive zakat, zakat recipients, 8 categories of zakat, asnaf, faqir, miskin, who is eligible for zakat, surah tawbah 60')
