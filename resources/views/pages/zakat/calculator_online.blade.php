...
@section('title', 'Zakat Calculator Online 2024 — Fast, Accurate & Free')
@section('meta_description', 'Use our free online Zakat calculator to easily compute your Zakat on cash, gold, silver, investments, and business assets. Get real-time Nisab updates.')
@section('meta_keywords', 'zakat calculator online, online zakat calculator, zakat on gold online, zakat calculation online, calculate zakat online, zakat 2024')
        ...
        <div class="zo-calc-wrapper">
            <div class="zo-header-stats">
                <div class="zo-stat-box">
                    ...
                    <div class="zo-stat-val">{{ $config->currency_code }} {{ number_format(87.48 * $config->gold_price_per_gram) }}</div>
                </div>
                <div class="zo-stat-box">
                    <div class="zo-stat-label">Current Silver Nisab (612.36g)</div>
                    <div class="zo-stat-val">{{ $config->currency_code }} {{ number_format(612.36 * $config->silver_price_per_gram) }}</div>
                </div>
            </div>
                ...
                <div class="zo-form-group">
                    ...
                    <div class="zo-input-row">
                        ...
                        <div class="zo-input-wrapper">
                            <span class="curr-symbol">{{ $config->currency_code }}</span>
            ...
            <div class="zo-summary" id="z_summary">
                ...
                <div class="zo-total-zakat">{{ $config->currency_code }} <span id="z_result_val">0</span></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const silverNisab = {{ 612.36 * $config->silver_price_per_gram }};
