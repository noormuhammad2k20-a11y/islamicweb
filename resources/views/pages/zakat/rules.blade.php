...
@section('title', 'Zakat Rules & Conditions — How to Calculate Zakat Correctly')
@section('meta_description', 'Learn the complete rules of Zakat in Islam. Discover what assets are zakatable, how to calculate it, and the conditions for paying Zakat.')
@section('meta_keywords', 'zakat rules, how to calculate zakat, zakat conditions, what is zakatable, zakat in islam, rules of zakat on gold, zakat on business')
