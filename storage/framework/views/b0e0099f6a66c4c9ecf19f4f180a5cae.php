...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The Islamic date today is <?php echo e($hijri['day']); ?> <?php echo e($hijri['month_name']); ?> <?php echo e($hijri['year']); ?> AH."
    }
  }, {
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The current Hijri year is <?php echo e($hijri['year']); ?> AH."
    }
  }]
}
</script>
...
<div class="page-header text-center" style="padding: 60px 20px; background: var(--bg-tinted); border-bottom: 1px solid var(--border-light);">
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <p style="font-size: 1.1rem; color: var(--text-medium); line-height: 1.6;">Accurate Hijri date for today corresponding to <strong><?php echo e($date->format('d F Y')); ?></strong> in the Gregorian calendar.</p>
    </div>
</div>
...
<div class="container" style="max-width: 1000px; margin: 50px auto; padding: 0 20px;">
    ...
    <div style="background: white; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); padding: 50px; margin-bottom: 40px; text-align: center;">
        ...
        <div style="display: inline-block; padding: 30px; background: var(--gold-tint); border: 2px solid var(--gold); border-radius: 12px;">
            <div style="font-size: 3rem; font-weight: bold; color: var(--navy); line-height: 1.2;">
                <?php echo e($hijri['day']); ?> <?php echo e($hijri['month_name']); ?> <?php echo e($hijri['year']); ?> AH
            </div>
            <div class="arabic" style="font-size: 2.2rem; color: var(--gold-dark); margin-top: 15px;">
                <?php echo e($hijri['day']); ?> <?php echo e($hijri['month_urdu']); ?> <?php echo e($hijri['year']); ?> ھ
            </div>
        </div>
    ...
    <div style="line-height: 1.8; color: var(--text-dark); margin-bottom: 50px; display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
        <div style="background: var(--bg-tinted); padding: 30px; border-radius: 8px;">
            ...
            <p>We are currently in the month of <strong><?php echo e($hijri['month_name']); ?></strong>, the <?php echo e($hijri['month']); ?>th month of the Islamic calendar.</p>
            <p style="margin-top: 15px;">
                <a href="<?php echo e(url('/islamic-month/' . Str::slug($hijri['month_name']))); ?>" style="color: var(--navy-light); text-decoration: underline; font-weight: bold;">Learn more about <?php echo e($hijri['month_name']); ?></a>
            </p>
        </div>
        ...
        <div style="background: var(--bg-tinted); padding: 30px; border-radius: 8px;">
            ...
            <div style="margin-top: 20px;">
                <a href="<?php echo e(route('converter.show')); ?>" style="display: inline-block; padding: 10px 20px; background: var(--navy); color: white; border-radius: 5px; text-decoration: none; font-weight: bold;">Gregorian to Hijri Converter</a>
            </div>
        </div>
    </div>

    <div style="text-align: center; margin-bottom: 30px;">
        <a href="<?php echo e(route('islamic-calendar')); ?>" style="display: inline-block; padding: 12px 25px; border: 2px solid var(--navy); color: var(--navy); border-radius: 5px; text-decoration: none; font-weight: bold;">View Full Islamic Calendar <?php echo e($hijri['year']); ?></a>
    </div>

</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/seo-pages/islamic-date-today.blade.php ENDPATH**/ ?>