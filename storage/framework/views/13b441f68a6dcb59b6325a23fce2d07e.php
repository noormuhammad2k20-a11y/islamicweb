...
<section class="section-container">
    <div class="hijri-span-card">
        ...
        <div style="color: #666; margin-top: 8px;">January <?php echo e($year); ?>: <?php echo e($startHijri['formatted']); ?> — December <?php echo e($year); ?>: <?php echo e($endHijri['formatted']); ?></div>
    </div>
</section>
...
<section class="section-container">
    <div class="year-nav">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($y = 2018; $y <= 2026; $y++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<section class="section-container">
    <div class="internal-links">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($year < 2030): ?><a href="<?php echo e(route('islamic-calendar-year', $year + 1)); ?>" class="internal-link"><?php echo e($year + 1); ?> →</a><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</section>
