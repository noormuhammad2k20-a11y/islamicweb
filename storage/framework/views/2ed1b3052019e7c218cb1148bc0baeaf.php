...
<?php $__env->startSection('title', 'How to Pray Salah — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Step-by-step visual prayer guide'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'How to Pray Salah','desc' => 'Step-by-step visual prayer guide','icon' => 'fa-child']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'How to Pray Salah','desc' => 'Step-by-step visual prayer guide','icon' => 'fa-child']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.module-card','data' => ['title' => ''.e($guide->title ?? $guide->name).'','desc' => ''.e(Str::limit($guide->description ?? $guide->overview ?? $guide->content, 80)).'','icon' => ''.e($guide->icon ?? 'fa-child').'','url' => '#','badge' => ''.e($guide->type ?? null).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($guide->title ?? $guide->name).'','desc' => ''.e(Str::limit($guide->description ?? $guide->overview ?? $guide->content, 80)).'','icon' => ''.e($guide->icon ?? 'fa-child').'','url' => '#','badge' => ''.e($guide->type ?? null).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/pages/namaz/salah.blade.php ENDPATH**/ ?>