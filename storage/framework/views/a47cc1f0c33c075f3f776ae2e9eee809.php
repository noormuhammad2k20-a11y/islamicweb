...
?>
<?php $__env->startSection('title', 'Islamic Date Today in ' . $country->name . ' — ' . $titleHijri . ' AH'); ?>
    ...
    <div class="section-inner">
        <div class="breadcrumb" style="text-align: center; margin-bottom: 40px;">
            <div style="background: rgba(255,255,255,0.9); padding: 10px 25px; border-radius: 50px; display: inline-block; box-shadow: 0 4px 15px rgba(0,0,0,0.05); font-size: 0.95rem;">
                ...
                <a href="<?php echo e(route('islamic-date.hub')); ?>" style="color: #999; text-decoration: none;">Islamic Date Today</a> 
                <span style="color: #ccc; margin: 0 10px;">/</span> 
                <span style="color: #666; font-weight: 600;"><?php echo e($country->name); ?></span>
            </div>
        </div>
        
        <div class="section-header">
            <div class="section-badge"><i class="fas fa-map-marker-alt"></i> <?php echo e($country->name); ?></div>
            <h1 class="section-title">Islamic Date in <span><?php echo e($country->name); ?></span></h1>
            <div class="arabic-divider"><span class="line"></span><span class="symbol">﷽</span><span class="line"></span></div>
            <p class="section-subtitle"><?php echo e($country->local_context_note ?? 'Today\'s Hijri Date and Islamic Calendar for ' . $country->name); ?></p>
        </div>
        ...
        <div class="section-header" style="margin-top: 60px;">
            ...
            <div class="arabic-divider"><span class="line"></span><span class="symbol">﷽</span><span class="line"></span></div>
            <p class="section-subtitle">Hijri Calendar for <?php echo e($hijriDate->hijri_month); ?> <?php echo e($hijriDate->hijri_year); ?> AH in <?php echo e($country->name); ?></p>
        </div>
        ...
        <div class="contact-grid" style="grid-template-columns: 1fr;" itemscope itemtype="https://schema.org/FAQPage">
            <div class="contact-info">
                <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" style="margin-bottom: 30px;">
                    <h3 itemprop="name" style="margin-bottom: 15px;"><i class="fas fa-moon" style="color: var(--gold); margin-right: 10px;"></i>Why does today's Islamic date differ between <?php echo e($country->name); ?> and Saudi Arabia?</h3>
                    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <p itemprop="text">Differences occur because Saudi Arabia predominantly uses a pre-calculated calendar (Umm al-Qura) or relies on local sightings within the Kingdom. Meanwhile, <?php echo e($country->name); ?> has its own criteria and local moon-sighting committees, meaning the crescent moon may be visible on different days depending on geographical location.</p>
                    </div>
                </div>
                <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <h3 itemprop="name" style="margin-bottom: 15px;"><i class="fas fa-binoculars" style="color: var(--gold); margin-right: 10px;"></i>Which moon-sighting authority does <?php echo e($country->name); ?> follow?</h3>
                    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
  ...
  "@graph": [
    {
      ...
      "name": "Islamic Date Today in <?php echo e($country->name); ?>",
      "description": "Find today's Islamic date (Hijri date), moon phase, and upcoming Islamic events in <?php echo e($country->name); ?>.",
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/pages/islamic-date/country.blade.php ENDPATH**/ ?>