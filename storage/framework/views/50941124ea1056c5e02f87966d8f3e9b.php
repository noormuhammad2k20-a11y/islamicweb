...
<head>
    ...
    ?>
    <link rel="alternate" hreflang="ur" href="<?php echo e(url()->current()); ?>" />
    <link rel="alternate" hreflang="en" href="<?php echo e(str_replace('/ur/', '/en/', url()->current())); ?>" />
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(file_exists(public_path('fonts/urdu-font.woff2'))): ?>
    <link rel="preload" href="<?php echo e(asset('fonts/urdu-font.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(file_exists(public_path('fonts/JameelNooriNastaleeq.woff2'))): ?>
    <link rel="preload" href="<?php echo e(asset('fonts/JameelNooriNastaleeq.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <nav class="navbar" id="navbar">
        <div class="navbar-inner">
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="<?php echo e(route('quiz.index')); ?>" class="<?php echo e(request()->routeIs('quiz.*') ? 'active' : ''); ?>"><i class="fas fa-clipboard-question"></i> Quiz</a></li>
