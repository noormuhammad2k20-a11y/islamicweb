...
<section class="controls-section">
    <div class="controls-bar">
        <form method="GET" action="<?php echo e(route('islamic-calendar')); ?>" style="display: flex; gap: 12px; flex-wrap: wrap; justify-content: center; width: 100%;">
            ...
            <div class="event-card">
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->event_name_urdu): ?>
                        <div style="font-family: 'Amiri', serif; color: var(--gold-dark); font-size: 0.9rem; margin-top: 4px;"><?php echo e($event->event_name_urdu); ?></div>
