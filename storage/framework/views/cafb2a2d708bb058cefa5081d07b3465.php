...
$value = context()->get($__contextArgs[0]); ?>": "https://schema.org",
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentRouteName): ?>
        ...
        <link rel="alternate" hreflang="ar" href="<?php echo e(route($currentRouteName, array_merge($routeParams, ['locale' => null]))); ?>" />
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<body>
    ...
    <div class="offcanvas-mobile" id="offcanvasMobile">
        ...
        <div class="offcanvas-body">
            ...
            <a href="<?php echo e(route('names.index')); ?>">Names</a>
            <a href="<?php echo e(route('wazaif.index')); ?>">Wazaif</a>
            <a href="<?php echo e(route('dreams.index')); ?>">Dreams</a>
            <a href="<?php echo e(route('quiz.index')); ?>">Quiz</a>
            <a href="<?php echo e(route('zakat.index')); ?>">Zakat</a>
            <a href="<?php echo e(route('hadith.index')); ?>">Hadith</a>
        </div>
    </div>
...
<footer class="footer">
    ...
    <script>
        ...
        var offcanvasCloseBtn = document.getElementById('offcanvasCloseBtn');
        var offcanvasMobile = document.getElementById('offcanvasMobile');
        ...
        document.querySelectorAll('.offcanvas-body a').forEach(function (link) {
