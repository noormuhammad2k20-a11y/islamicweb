...
<?php $__env->startSection('title', 'Umrah Checklist — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Downloadable preparation list'); ?>
    ...
    <div class="section-inner">
        <div class="breadcrumb" style="text-align: center; margin-bottom: 40px;">
            <div style="background: rgba(255,255,255,0.9); padding: 10px 25px; border-radius: 50px; display: inline-block; box-shadow: 0 4px 15px rgba(0,0,0,0.05); font-size: 0.95rem;">
                ...
                <span style="color: #666; font-weight: 600;">Umrah Checklist</span>
            </div>
        </div>

        <div class="section-header">
            <div class="section-badge"><i class="fas fa-clipboard-check"></i> Feature</div>
            <h1 class="section-title">Umrah Checklist</h1>
        ...
        <div style="max-width: 900px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
            ...
            <div style="background: #fff; border: 1px solid #eaeaea; border-radius: 8px; padding: 25px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0; color: var(--text-color); font-size: 0.95rem; line-height: 1.8;">
                    <li><i class="fas fa-check-circle" style="color: var(--primary); margin-right: 8px; font-size: 0.85rem;"></i> Passport & Umrah Visa</li>
            ...
            <div style="background: #fff; border: 1px solid #eaeaea; border-radius: 8px; padding: 25px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0; color: var(--text-color); font-size: 0.95rem; line-height: 1.8;">
                    <li><i class="fas fa-check-circle" style="color: var(--primary); margin-right: 8px; font-size: 0.85rem;"></i> 2 Sets of Ihram (Men)</li>
            ...
            <div style="background: #fff; border: 1px solid #eaeaea; border-radius: 8px; padding: 25px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0; color: var(--text-color); font-size: 0.95rem; line-height: 1.8;">
                    ...
                    <li><i class="fas fa-check-circle" style="color: var(--primary); margin-right: 8px; font-size: 0.85rem;"></i> Duas Book & Umrah Guide</li>
                    ...
                    <li><i class="fas fa-check-circle" style="color: var(--primary); margin-right: 8px; font-size: 0.85rem;"></i> Small Scissors (for Tahallul)</li>
                </ul>
            </div>
