...
<title><?php echo e($name->transliteration); ?> (<?php echo e($name->arabic); ?>) — Meaning & Benefits | 99 Names of Allah | Noor-e-Islam</title>
<meta name="description" content="<?php echo e($name->transliteration); ?> meaning: <?php echo e($name->meaning_english); ?>. Learn the linguistic root, Quranic references, virtues, and how to call upon Allah using the name <?php echo e($name->arabic); ?>.">
<link rel="canonical" href="<?php echo e(url('/99-names-of-allah/' . $name->slug)); ?>">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="article">
<meta property="og:url" content="<?php echo e(url('/99-names-of-allah/' . $name->slug)); ?>">
<meta property="og:title" content="<?php echo e($name->transliteration); ?> (<?php echo e($name->arabic); ?>) — Meaning & Benefits">
<meta property="og:description" content="<?php echo e($name->transliteration); ?> meaning: <?php echo e($name->meaning_english); ?>. Learn the linguistic root, Quranic references, and virtues.">
<meta property="og:site_name" content="Noor-e-Islam">

<!-- Twitter -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="<?php echo e($name->transliteration); ?> (<?php echo e($name->arabic); ?>) — Meaning & Benefits">
<meta name="twitter:description" content="<?php echo e($name->transliteration); ?> meaning: <?php echo e($name->meaning_english); ?>. Learn the linguistic root, Quranic references, and virtues.">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "Meaning and Benefits of <?php echo e($name->transliteration); ?> (<?php echo e($name->arabic); ?>)",
      "description": "<?php echo e($name->meaning_english); ?>",
      "url": "<?php echo e(url('/99-names-of-allah/' . $name->slug)); ?>",
      "author": {
        "@type": "Organization",
        "name": "Noor-e-Islam"
      },
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "<?php echo e(url('/99-names-of-allah')); ?>"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "<?php echo e($name->transliteration); ?>"
        }
      ]
    }
  ]
...
<section class="name-hero">
    <div class="hero-breadcrumb">
        ...
        <i class="fas fa-chevron-right"></i>
        <span class="active"><?php echo e($name->transliteration); ?></span>
    </div>

    <div class="hero-meta">
        <i class="fas fa-star"></i> Name #<?php echo e($name->number); ?> of 99
    </div>
    
    <div class="arabic-display"><?php echo e($name->arabic); ?></div>
    <h1 class="name-transliteration"><?php echo e($name->transliteration); ?></h1>
    ...
    <div>
        <div class="meaning-cards-grid">
            <div class="meaning-card en-card">
                ...
                <div class="meaning-value"><?php echo e($name->meaning_english); ?></div>
            </div>
            <div class="meaning-card ur-card">
                ...
                <div class="meaning-value urdu-text" dir="rtl"><?php echo e($name->meaning_urdu ?? 'جلد آرہا ہے'); ?></div>
            </div>
        </div>
        ...
        <div class="content-block-wrapper">
            ...
            <div class="block-content">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($name->quran_reference): ?>
    ...
    <aside>
        <div class="sidebar-widget">
            ...
            <div class="names-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allNames ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="/99-names-of-allah/<?php echo e($n->slug); ?>" title="Learn the meaning of <?php echo e($n->transliteration); ?>" class="name-list-item <?php echo e($n->id === $name->id ? 'active' : ''); ?>" style="color: var(--text-medium);">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <span style="font-size: .75rem; color: var(--text-faint); font-weight: 600;"><?php echo e($n->number); ?>.</span>
                        <span style="font-weight: 600; color: var(--navy);"><?php echo e($n->transliteration); ?></span>
                    </div>
                    <span style="font-family: 'Scheherazade New', serif; font-size: 1.2rem; color: <?php echo e($n->id === $name->id ? 'var(--gold-dark)' : 'var(--text-light)'); ?>;"><?php echo e($n->arabic); ?></span>
                </a>
...
<div class="nav-container">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($previousName): ?>
        <a href="/99-names-of-allah/<?php echo e($previousName->slug); ?>" class="nav-btn" style="align-items: flex-start;">
            <span class="nav-label">Previous Name</span>
            <span class="nav-value"><i class="fas fa-arrow-left"></i> <?php echo e($previousName->transliteration); ?></span>
        </a>
    <?php else: ?>
        <div style="flex: 1;"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextName): ?>
        <a href="/99-names-of-allah/<?php echo e($nextName->slug); ?>" class="nav-btn" style="align-items: flex-end; text-align: right;">
            <span class="nav-label">Next Name</span>
            <span class="nav-value"><?php echo e($nextName->transliteration); ?> <i class="fas fa-arrow-right"></i></span>
        </a>
    <?php else: ?>
        <div style="flex: 1;"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
function copyName() {
    navigator.clipboard.writeText('<?php echo e($name->arabic); ?>');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/allah-names/show.blade.php ENDPATH**/ ?>