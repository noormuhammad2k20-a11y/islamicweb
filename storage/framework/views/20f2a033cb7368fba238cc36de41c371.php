    ...
    <div class="section-inner">
        ...
        <div class="contact-grid" style="grid-template-columns: 1fr; margin-bottom: 50px;">
            ...
            <div class="search-card">
                ...
                <form action="<?php echo e(route('names.index')); ?>" method="GET" style="display: flex; gap: 15px; flex-wrap: wrap;">
                    <input type="text" name="search" class="search-input" placeholder="Search by English or Urdu meaning..." value="<?php echo e(request('search')); ?>">
                ...
                <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-top: 25px;">
                    <a href="<?php echo e(route('names.gender', 'boys')); ?>" style="padding: 10px 20px; background: rgba(52, 152, 219, 0.05); color: #2980b9; border-radius: 50px; text-decoration: none; font-size: 0.95rem; font-weight: 500; border: 1px solid rgba(52, 152, 219, 0.2); transition: all 0.2s;"><i class="fas fa-male"></i> Popular Boys Names</a>
                    <a href="<?php echo e(route('names.gender', 'girls')); ?>" style="padding: 10px 20px; background: rgba(233, 30, 99, 0.05); color: #c2185b; border-radius: 50px; text-decoration: none; font-size: 0.95rem; font-weight: 500; border: 1px solid rgba(233, 30, 99, 0.2); transition: all 0.2s;"><i class="fas fa-female"></i> Popular Girls Names</a>
                </div>
            </div>
        </div>
        ...
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
                <h3 style="color: var(--primary-dark); margin: 0; font-size: 1.6rem;">
                    ...
                    <?php echo e(isset($gender) ? ucfirst($gender) . ' Names' : (request('search') ? 'Search Results' : 'Trending Names')); ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 25px;">
                ...
                <a href="<?php echo e(route('names.show', $name->slug)); ?>" class="name-card">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <h4 class="name-en"><?php echo e($name->name_english); ?></h4>
                        <span class="name-ar" dir="rtl"><?php echo e($name->name_arabic); ?></span>
                    </div>
                    <p class="name-meaning">Meaning: <strong><?php echo e($name->translation_urdu); ?></strong></p>
                    <div style="display: flex; gap: 10px;">
                        <span class="tag tag-gender <?php echo e($name->gender); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($name->origin): ?>
                            <span class="tag tag-origin"><i class="fas fa-globe"></i> <?php echo e(ucfirst($name->origin)); ?></span>
