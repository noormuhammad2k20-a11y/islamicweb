...
<p><strong>Ramadan</strong> (<?php echo e($hijri_month->name_ar); ?>) is the ninth and holiest month of the Islamic Hijri calendar. The name is derived from the Arabic root "Ramad," which means scorching heat or intense dryness, metaphorically symbolizing how fasting in this month burns away the sins of the believers.</p>
...
<?php echo $__env->make('pages.events.month_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\events\months\ramadan.blade.php ENDPATH**/ ?>