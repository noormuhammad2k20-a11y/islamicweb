...
<?php $__env->startSection('title', 'Hijri to Gregorian Date Converter — Accurate Islamic Calendar'); ?>
<?php $__env->startSection('meta_description', 'Convert dates between the Islamic Hijri calendar and the Gregorian calendar. Find out the Islamic date for your birthday, anniversaries, or important events.'); ?>
                    ...
                    <form id="form-g-to-h" onsubmit="convertDate(event, 'g2h')" style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center; align-items: center;">
                        <div class="form-group" style="margin-bottom: 0;">
                            <select id="g-day" style="padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 1rem; outline: none;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i=1; $i<=31; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            <input type="number" id="g-year" value="<?php echo e(date('Y')); ?>" min="1900" max="2100" style="padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 1rem; outline: none; width: 100px;">
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\converter\show.blade.php ENDPATH**/ ?>