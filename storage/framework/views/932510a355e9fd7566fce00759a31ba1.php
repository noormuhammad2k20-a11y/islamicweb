...
<?php $__env->startSection('title', 'The 5 Pillars of Islam — Arkan al-Islam'); ?>
<?php $__env->startSection('meta_description', 'Learn about the Five Pillars of Islam: Shahada (Faith), Salah (Prayer), Zakat (Charity), Sawm (Fasting), and Hajj (Pilgrimage).'); ?>
<?php $__env->startSection('meta_keywords', '5 pillars of islam, arkan al islam, shahada, salah, zakat, sawm, hajj, pillars of islam explained'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/pages/knowledge/pillars_islam.blade.php ENDPATH**/ ?>