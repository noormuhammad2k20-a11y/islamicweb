    ...
    <div class="grid-10">
        ...
        <div class="app-card hero-card col-7">
            <nav class="hero-breadcrumbs">
                ...
                <span>/</span>
                <a href="/prayer-times/<?php echo e($citySlug); ?>"><?php echo e($city->name); ?></a>
                <span>/</span>
                <span class="active"><?php echo e(ucfirst($prayerName)); ?></span>
            </nav>
            
            <h1 class="hero-title font-playfair"><?php echo e(ucfirst($prayerName)); ?> Prayer in <?php echo e($name); ?></h1>
            <p class="hero-subtitle">Complete schedule, calculation methodology, and virtues for <?php echo e(is_object($city->country) ? $city->country->name : $city->country); ?>.</p>
            ...
            <div style="display: flex; gap: 16px; margin-top: 32px; flex-wrap: wrap;">
                <div style="background: rgba(255,255,255,0.1); padding: 10px 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div style="font-weight: 600;"><?php echo e(now($tz)->format('l, d F Y')); ?></div>
                </div>
                <div style="background: rgba(255,255,255,0.1); padding: 10px 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2);">
                    <div style="font-size: 0.75rem; text-transform: uppercase; opacity: 0.7; margin-bottom: 4px;">Islamic Date</div>
                    <div style="font-weight: 600;"><?php echo e($hijri['day']); ?> <?php echo e($hijri['month_name']); ?> <?php echo e($hijri['year']); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="app-card timer-card col-3">
            <div class="timer-label">Today's <?php echo e(ucfirst($prayerName)); ?></div>
            <div class="timer-value"><?php echo e($prayers[$prayerKey] ?? '--:--'); ?></div>
            
            <div style="width: 100%; height: 1px; background: #E2E8F0; margin: 24px 0;"></div>
            
            <div class="timer-label" style="color: var(--primary);">Next Prayer: <?php echo e($next['name']); ?></div>
            <div class="timer-countdown"><?php echo e($next['countdown'] ?? '00:00:00'); ?></div>
        </div>
    </div>
    ...
    <div class="grid-10">
            ...
            <div class="app-card" id="printable-calendar">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                    <h2 class="section-title" style="margin-bottom: 0;">
                        ...
                        Monthly Timetable - <?php echo e($name); ?>
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>Day</th>
                                <th style="color: var(--primary);"><?php echo e(ucfirst($prayerName)); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo e($day['is_today'] ? 'row-today' : ''); ?>">
                                <td><?php echo e($day['date']); ?></td>
                                <td><?php echo e(substr($day['dow'], 0, 3)); ?></td>
                                <td style="font-size: 1.1rem;"><?php echo e($day[$prayerKey] ?? '--:--'); ?></td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($prayerName, ['fajr'])): ?> <td><?php echo e($day['sunrise'] ?? '--:--'); ?></td> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($prayerName, ['maghrib'])): ?> <td><?php echo e($day['isha'] ?? '--:--'); ?></td> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </tr>
            ...
            <?php else: ?>
                <div class="app-card">
                    ...
                    <p style="color: var(--text-main); line-height: 1.8; margin-bottom: 24px;">
                        The <strong><?php echo e(ucfirst($prayerName)); ?></strong> prayer is an obligatory (Fard) prayer and holds immense significance in the daily life of a Muslim. Establishing the five daily prayers is the second pillar of Islam and serves as a direct link between the believer and Allah (SWT).
                    </p>
        ...
        <div class="col-3" style="display: flex; flex-direction: column; gap: 30px;">
            ...
            <div class="app-card" style="padding: 24px;">
                ...
                <div class="info-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prayerName == 'fajr'): ?>
                        <div class="info-item">
                            <span class="info-label">Before Fard</span>
                            <span class="info-val">2 Rakaat</span>
                        </div>
                    <?php elseif($prayerName == 'zuhr'): ?>
                        <div class="info-item">
                            <span class="info-label">Before Fard</span>
                    ...
                    <?php elseif($prayerName == 'asr'): ?>
                        <div class="info-item">
                            <span class="info-label">Before Fard</span>
                            <span class="info-val">4 Rakaat</span>
                        </div>
                    <?php elseif($prayerName == 'maghrib'): ?>
                        <div class="info-item">
                            <span class="info-label">After Fard</span>
                            <span class="info-val">2 Rakaat</span>
                        </div>
                    <?php elseif($prayerName == 'isha'): ?>
                        <div class="info-item">
                            <span class="info-label">Before Fard</span>
                            <span class="info-val">4 Rakaat</span>
                        </div>
            ...
            <div class="app-card" style="padding: 24px; background: var(--primary); color: white; border: none;">
                ...
                <div class="info-list">
                    ...
                    <div class="info-item" style="background: rgba(197, 160, 89, 0.2); border: 1px solid rgba(197, 160, 89, 0.4);">
                        ...
                        <span class="info-val" style="color: var(--gold-light);"><?php echo e(number_format($qibla ?? 0, 1)); ?>° N</span>
                    </div>
                </div>
            </div>
