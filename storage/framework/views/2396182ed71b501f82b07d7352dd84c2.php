...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="navbar-inner">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo e(route('duas.index')); ?>">Duas</a></li>
                <li><a href="<?php echo e(route('names_allah.index')); ?>">Names</a></li>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="<?php echo e(route('prayer-times.hub')); ?>">Prayer Times</a>
        <a href="<?php echo e(route('duas.index')); ?>">Duas</a>
        <a href="<?php echo e(route('names_allah.index')); ?>">Names</a>
    ...
    <section class="hero" id="home">
        ...
        <div class="hero-inner">
            <div class="hero-content">
                <div class="hero-badge"><i class="fas fa-star-and-crescent"></i> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($hijriDate)): ?>
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('quran.index')); ?>" class="btn-primary"><i class="fas fa-book-quran"></i> Read Quran</a>
                    <a href="<?php echo e(route('duas.index')); ?>" class="btn-outline-hero"><i class="fas fa-compass"></i> Explore</a>
                </div>
            </div>
            <div class="hero-visual">
                ...
                <div class="floating-ayah-card">
                    ...
                    <div>
                        ...
                        ?>
                        <p><?php echo e($nextPrayerName); ?> at <?php echo e($nextPrayerTime); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="prayer-widget">
            ...
            <div class="pw-list">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentPrayerTime): ?>
                        <div class="pw-time"><span class="pw-name">Fajr</span><span class="pw-val"><?php echo e(\Carbon\Carbon::parse($currentPrayerTime->fajr)->format('h:i A')); ?></span></div>
                        <div class="pw-time"><span class="pw-name">Sunrise</span><span class="pw-val"><?php echo e(\Carbon\Carbon::parse($currentPrayerTime->sunrise)->format('h:i A')); ?></span></div>
                        <div class="pw-time"><span class="pw-name">Dhuhr</span><span class="pw-val"><?php echo e(\Carbon\Carbon::parse($currentPrayerTime->dhuhr)->format('h:i A')); ?></span></div>
                        <div class="pw-time active"><span class="pw-name">Asr</span><span class="pw-val"><?php echo e(\Carbon\Carbon::parse($currentPrayerTime->asr)->format('h:i A')); ?></span></div>
                        <div class="pw-time"><span class="pw-name">Maghrib</span><span class="pw-val"><?php echo e(\Carbon\Carbon::parse($currentPrayerTime->maghrib)->format('h:i A')); ?></span></div>
                        <div class="pw-time"><span class="pw-name">Isha</span><span class="pw-val"><?php echo e(\Carbon\Carbon::parse($currentPrayerTime->isha)->format('h:i A')); ?></span></div>
                    <?php else: ?>
    ...
    <section class="section about-section" id="about">
        <div class="section-inner">
            ...
            <div class="about-features-new">
                <a href="<?php echo e(route('islamic-calendar')); ?>" class="af-card">
                ...
                <a href="<?php echo e(route('prayer-times.hub')); ?>" class="af-card">
                ...
                <a href="<?php echo e(route('duas.index')); ?>" class="af-card">
    ...
    <section class="explore-features-section" id="explore">
        <div class="section-inner">
            ...
            <div class="explore-features-grid">
                <a href="<?php echo e(route('quran.index')); ?>" class="explore-feature-card">
                    <div class="ef-icon-wrap"><i class="fas fa-book-quran"></i></div>
                    <h3 class="ef-title">Holy Quran</h3>
                    <p class="ef-desc">Read all 114 Surahs with Arabic text, English translation, and audio recitation
                        by renowned Qaris.</p>
                    <span class="ef-cta">Read Now <i class="fas fa-arrow-right"></i></span>
                </a>
                <a href="<?php echo e(route('duas.index')); ?>" class="explore-feature-card">
                ...
                <a href="<?php echo e(route('hadith.index')); ?>" class="explore-feature-card">
                ...
                <a href="<?php echo e(route('names_allah.index')); ?>" class="explore-feature-card">
                ...
                <a href="<?php echo e(route('islamic-calendar')); ?>" class="explore-feature-card">
                ...
                <a href="<?php echo e(route('knowledge.index')); ?>" class="explore-feature-card">
    ...
    <section class="section duas-section" id="duas">
        <div class="section-inner">
            ...
            <div class="duas-grid" id="duasGrid" role="list" aria-label="Featured Daily Duas">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($dailyDuas) && $dailyDuas->count() > 0): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dailyDuas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dua): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(url('/duas/' . ($dua->primary_category_slug ?? 'general') . '/' . $dua->seo_slug)); ?>" class="dua-card reveal visible" role="listitem" aria-label="Read full <?php echo e($dua->title_english ?? $dua->title_roman_urdu); ?>">
                        <div class="dua-card-top">
                            <div class="dua-icon"><i class="fas fa-hands-praying" aria-hidden="true"></i></div>
                            <span class="dua-category-badge"><i class="fas fa-tag" aria-hidden="true"></i> <?php echo e($dua->categories->first()->name ?? 'Daily Life'); ?></span>
                        </div>
                        <h3 class="dua-name"><?php echo e($dua->title_english ?? $dua->title_roman_urdu); ?></h3>
                        <p class="dua-arabic arabic" dir="rtl" lang="ar"><?php echo e(Str::limit($dua->arabic_text, 100)); ?></p>
                        <p class="dua-desc"><?php echo e(Str::limit($dua->short_meaning, 80)); ?></p>
        ...
        <div class="section-inner">
            ...
            <div class="surahs-grid" id="surahsGrid" role="list" aria-label="Featured Popular Surahs">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($popularSurahs) && $popularSurahs->count() > 0): ?>
                    ...
                    <a href="<?php echo e(route('surah.show', $surah->slug ?? $surah->id)); ?>" class="surah-card reveal visible" role="listitem" aria-label="Read Surah <?php echo e($surah->english_name); ?>">
                        <div class="surah-card-top">
                            <div class="surah-icon"><i class="fas fa-book-open" aria-hidden="true"></i></div>
                            <span class="surah-badge <?php echo e(strtolower($surah->revelation_type)); ?>"><i class="fas fa-circle" aria-hidden="true"></i> <?php echo e($surah->revelation_type); ?></span>
                        </div>
                        <span class="surah-num">Surah <?php echo e($surah->number); ?></span>
                        <h3 class="surah-name-en"><?php echo e($surah->name_en); ?></h3>
                        <p class="surah-name-ar arabic" dir="rtl" lang="ar"><?php echo e($surah->name_ar); ?></p>
                        <div class="surah-meta">
                            <span><i class="fas fa-list-ol" aria-hidden="true"></i> <?php echo e($surah->total_ayahs); ?> Ayahs</span>
                        </div>
                        <p class="surah-desc"><?php echo e(Str::limit($surah->meaning_en ?? 'A beautiful and profound chapter of the Holy Quran.', 80)); ?></p>
        ...
        <div class="section-inner">
            ...
            <div class="names-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($allahNames) && $allahNames->count() > 0): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allahNames->take(12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="name-card">
                        <div class="name-header"><span class="name-num"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></span><span class="name-arabic arabic"><?php echo e($name->arabic); ?></span></div>
                        <h4><?php echo e($name->transliteration); ?></h4>
                        <p class="name-meaning"><?php echo e(Str::limit($name->meaning_english, 50)); ?></p>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="center-btn-wrap" style="text-align:center;margin-top:50px;"><a href="<?php echo e(route('names_allah.index')); ?>" class="btn-primary"><i class="fas fa-list-ol"></i> View All 99 Names</a></div>
        </div>
    </section>
                ...
                <div class="events-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($upcomingEvents) && $upcomingEvents->count() > 0): ?>
                        ...
                        <div class="event-item">
                            <div class="event-date"><span class="day"><?php echo e($event->hijri_day); ?></span><span class="month"><?php echo e(substr($event->hijri_month, 0, 3)); ?></span></div>
                            <div class="event-info">
                                <h4><?php echo e($event->name); ?></h4>
                                <p><i class="fas fa-calendar-check"></i> Expected: <?php echo e(\Carbon\Carbon::parse($event->estimated_gregorian_date)->format('M d, Y')); ?></p>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php else: ?>
                ...
                <div class="resources-box">
                    ...
                    <div class="resource-links">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($latestArticles) && $latestArticles->count() > 0): ?>
                            ...
                            <a href="<?php echo e(url('/articles/' . $article->slug)); ?>" class="res-link"><i class="fas fa-book-open"></i> <?php echo e(Str::limit($article->title, 25)); ?></a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <a href="<?php echo e(url('/articles')); ?>" class="res-link" style="color: var(--gold);"><i class="fas fa-arrow-right"></i> View All Articles</a>
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('quran.index')); ?>" class="res-link"><i class="fas fa-book-quran"></i> Holy Quran</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('quran.index')); ?>"><i class="fas fa-chevron-right"></i> Quran</a></li>
                        <li><a href="<?php echo e(route('names_allah.index')); ?>"><i class="fas fa-chevron-right"></i> 99 Names</a></li>
...
</html><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/home.blade.php ENDPATH**/ ?>