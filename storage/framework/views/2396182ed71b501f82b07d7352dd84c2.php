        ...
        <div class="hero-inner">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('islamic-calendar')); ?>" class="btn-primary"><i class="fas fa-calendar-day"></i> Islamic Calendar</a>
            ...
            <div class="about-grid">
                ...
                <div class="about-content">
                    ...
                    <div class="about-features" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-top: 25px;">
                        <a href="<?php echo e(route('islamic-calendar')); ?>" class="about-feature-link">
                            <div class="icon-box"><i class="fas fa-calendar-day"></i></div>
                            <span>Live Hijri Date</span>
                        </a>
                        <a href="<?php echo e(route('prayer-times.hub')); ?>" class="about-feature-link">
                            <div class="icon-box"><i class="fas fa-clock"></i></div>
                            <span>Prayer Times by City</span>
                        </a>
                        <a href="<?php echo e(route('duas.index')); ?>" class="about-feature-link">
                            <div class="icon-box"><i class="fas fa-hands-praying"></i></div>
                            <span>Daily Islamic Duas</span>
                        </a>
                        <a href="<?php echo e(route('quran.index')); ?>" class="about-feature-link">
                            <div class="icon-box"><i class="fas fa-book-open"></i></div>
                            <span>Surah & Fazilat</span>
                        </a>
                        <a href="<?php echo e(route('hadith.index')); ?>" class="about-feature-link">
                            <div class="icon-box"><i class="fas fa-scroll"></i></div>
                            <span>Authentic Hadith</span>
                        </a>
                        <a href="<?php echo e(route('converter.show')); ?>" class="about-feature-link">
        ...
        <div class="section-inner">
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <a href="<?php echo e(route('duas.index')); ?>" class="service-link">Read Duas <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="service-card">
                    ...
                    <a href="<?php echo e(route('islamic-calendar')); ?>" class="service-link">View Calendar <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="service-card">
    ...
    <section class="section compact-features-section" id="more-features" style="background: var(--white); padding-top: 40px; padding-bottom: 90px;">
        <div class="section-inner">
            ...
            <div class="compact-grid">
                <a href="<?php echo e(route('duas.index')); ?>" class="compact-card">
