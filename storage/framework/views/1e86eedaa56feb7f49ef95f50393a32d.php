...
<p><strong>Rabi' al-Awwal</strong> (<?php echo e($hijri_month->name_ar); ?>) is the third month of the Islamic calendar. Linguistically, the word "Rabi" translates to "spring," reflecting the season during which this month was originally named in pre-Islamic Arabia. However, for the Muslim Ummah, this month represents a profound spiritual spring&mdash;the birth of the final Messenger, Prophet Muhammad (peace be upon him).</p>
...
<?php echo $__env->make('pages.events.month_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\events\months\rabi-al-awwal.blade.php ENDPATH**/ ?>