...
<div class="hub-container">
    ...
    <div class="hub-grid">
        <a href="<?php echo e(route('hajj_umrah.hajj_guide')); ?>" class="hub-card">
        ...
        <a href="<?php echo e(route('hajj_umrah.hajj_duas')); ?>" class="hub-card">
        ...
        <a href="<?php echo e(route('hajj_umrah.hajj_checklist')); ?>" class="hub-card">
    ...
    <div class="hub-grid">
        <a href="<?php echo e(route('hajj_umrah.umrah_guide')); ?>" class="hub-card">
        ...
        <a href="<?php echo e(route('hajj_umrah.umrah_duas')); ?>" class="hub-card">
        ...
        <a href="<?php echo e(route('hajj_umrah.umrah_checklist')); ?>" class="hub-card">
    ...
    <div style="text-align: center; margin-top: 20px;">
        <a href="<?php echo e(route('hajj_umrah.hajj_faqs')); ?>" style="display: inline-block; background: var(--primary); color: white; padding: 15px 40px; border-radius: 50px; font-size: 1.2rem; font-weight: bold; text-decoration: none; transition: transform 0.3s; box-shadow: 0 4px 15px rgba(10,58,42,0.3);" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='none'">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/pages/hajj_umrah/hub.blade.php ENDPATH**/ ?>