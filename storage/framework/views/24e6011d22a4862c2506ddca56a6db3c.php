<?php $__env->startSection('title', $hijri_month->name_en . ' — Islamic Calendar & Historical Events'); ?>
<?php $__env->startSection('meta_description', 'Discover the historical events, significance, and detailed overview of the Islamic month of ' . $hijri_month->name_en . '.'); ?>
    ...
    <div class="container">
        ...
        <div class="breadcrumb" style="text-align: center; margin-bottom: 30px;">
            <div style="background: rgba(255,255,255,0.9); padding: 12px 30px; border-radius: 50px; display: inline-block; box-shadow: 0 4px 15px rgba(0,0,0,0.03); font-size: 0.95rem; border: 1px solid rgba(0,0,0,0.02);">
                ...
                <a href="<?php echo e(route('events.index')); ?>" style="color: #888; text-decoration: none; font-weight: 500;">Islamic Calendar</a> 
                <span style="color: #ccc; margin: 0 12px;">/</span> 
                <span style="color: var(--primary-dark); font-weight: 600;"><?php echo e($hijri_month->name_en); ?></span>
            </div>
        </div>

        <div class="month-hero">
            <h1 class="month-arabic"><?php echo e($hijri_month->name_ar); ?></h1>
            <div class="month-english"><?php echo e($hijri_month->name_en); ?> <?php echo e($currentHijriYear ?? ''); ?></div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 mx-auto">
                ...
                <div class="vip-card">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hijri_month->events && $hijri_month->events->count() > 0): ?>
                        <div class="events-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $hijri_month->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="event-card">
                                    <div class="event-date">
                                        <span class="day"><?php echo e($event->day); ?></span>
                                        <span class="month-abbr"><?php echo e(substr($hijri_month->name_en, 0, 3)); ?></span>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/pages/events/month.blade.php ENDPATH**/ ?>