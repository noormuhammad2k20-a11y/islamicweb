...
<?php $__env->startSection('title', $seoMeta->title ?? 'Sehri & Iftar Time ' . $city->name . ' ' . $year); ?>
...
<section class="date-hero">
    <div class="breadcrumb-modern">
        ...
        <a href="<?php echo e(route('ramadan.hub', $year)); ?>" style="color: #ddd; text-decoration: none;">Ramadan <?php echo e($year); ?></a> 
        <span style="color: rgba(255,255,255,0.5); margin: 0 8px;">/</span> 
        <span style="color: white; font-weight: 600;"><?php echo e($city->name); ?></span>
    </div>
    
    <h1 class="date-hero-title"><?php echo e($seoMeta->h1 ?? $city->name . ' Sehri & Iftar Timings ' . $year . ' — رمضان اوقات'); ?></h1>
    <p class="date-hero-subtitle">
        Complete Ramadan <?php echo e($year); ?> sehri and iftar timings for <?php echo e($city->name); ?>.
    </p>


        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($todayTiming): ?>
        <div class="prayer-cards-grid">
            <div class="main-date-card">
                <div class="card-region">Today's Sehri Time</div>
                <div class="hijri-day-large"><?php echo e($todayTiming->sehri_time); ?></div>
            </div>
            <div class="main-date-card">
                <div class="card-region">Today's Iftar Time</div>
                <div class="hijri-day-large"><?php echo e($todayTiming->iftar_time); ?></div>
            </div>
        </div>
...
<section class="section-container">
    ...
    <div id="monthly-timetable-section">
        <div style="display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap; margin-bottom: 30px;">
            <h2 class="section-title" style="margin-bottom: 0;">Full Ramadan <?php echo e($year); ?> Timetable — <?php echo e($city->name); ?></h2>
        ...
        <script>
            function printTimetable() {
                ...
                var cityName = '<?php echo e($city->name); ?>';
                var title = 'Ramadan <?php echo e($year); ?> Timetable - ' + cityName;
            ...
            function downloadCSV() {
                ...
                var filename = 'Ramadan_<?php echo e($year); ?>_<?php echo e($city->name); ?>_Timetable.csv';
        ...
        <div style="background: white; border-radius: 16px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light); overflow: auto; margin-bottom: 50px;">
            <table class="table-modern">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $timings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="<?php echo e(\Carbon\Carbon::parse($t->date)->isToday() ? 'today-row' : ''); ?>">
                        <td><?php echo e($t->day); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($t->date)->format('d M, Y')); ?></td>
                        <td><?php echo e($t->sehri_time); ?></td>
                        <td><?php echo e($t->iftar_time); ?></td>
                    </tr>
    ...
    <div style="text-align: center;">
        <h2 class="section-title"><?php echo e($city->name); ?> Ramadan Guidelines</h2>
    </div>
    <div style="background: white; padding: 30px; border-radius: 16px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light); margin-bottom: 50px; text-align: center;">
        <p style="line-height: 1.8; color: #555; font-size: 1.1rem;">
            The Sehri and Iftar times provided for <strong><?php echo e($city->name); ?></strong> are calculated using the <strong>Karachi / Islamic University of Sciences</strong> method.
    ...
    <div class="faq-section" itemscope itemtype="https://schema.org/FAQPage" style="max-width: 800px; margin: 0 auto; margin-bottom: 50px;">
        <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" style="background: white; padding: 25px; border-radius: 16px; margin-bottom: 20px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light);">
            <h3 itemprop="name" style="font-size: 1.2rem; color: var(--primary); font-family: 'Playfair Display', serif; margin: 0 0 10px;">What is the exact Sehri time in <?php echo e($city->name); ?> today?</h3>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <div itemprop="text" style="color: #555; line-height: 1.8;">
                    Today, the Sehri time in <?php echo e($city->name); ?> ends at exactly <strong><?php echo e($todayTiming ? $todayTiming->sehri_time : 'N/A'); ?></strong>. It is highly recommended to stop eating and drinking at least 1-2 minutes before this time to be safe.
                </div>
            </div>
        </div>
        
        <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" style="background: white; padding: 25px; border-radius: 16px; margin-bottom: 20px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light);">
            <h3 itemprop="name" style="font-size: 1.2rem; color: var(--primary); font-family: 'Playfair Display', serif; margin: 0 0 10px;">What is the Iftar time in <?php echo e($city->name); ?> today?</h3>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <div itemprop="text" style="color: #555; line-height: 1.8;">
                    Iftar time in <?php echo e($city->name); ?> today is at <strong><?php echo e($todayTiming ? $todayTiming->iftar_time : 'N/A'); ?></strong>. This marks the time of Maghrib prayer, when Muslims break their fast.
                </div>
            </div>
        </div>

        <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" style="background: white; padding: 25px; border-radius: 16px; margin-bottom: 20px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light);">
            <h3 itemprop="name" style="font-size: 1.2rem; color: var(--primary); font-family: 'Playfair Display', serif; margin: 0 0 10px;">How is the Ramadan timetable calculated for <?php echo e($city->name); ?>?</h3>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <div itemprop="text" style="color: #555; line-height: 1.8;">
                    The Ramadan timings for <?php echo e($city->name); ?> are calculated using the widely accepted <strong>Islamic University of Sciences (Karachi)</strong> methodology, which is the standard calculation method for the Hanafi school of thought in this region.
                </div>
            </div>
        </div>
    ...
    <div style="text-align: center;">
        <h2 class="section-title">Explore More for <?php echo e($city->name); ?></h2>
    </div>
    <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-bottom: 50px; max-width: 1000px; margin-left: auto; margin-right: auto;">
        <a href="<?php echo e(route('prayer-times.city', ['city' => Str::slug($city->name)])); ?>" style="text-decoration: none; background: linear-gradient(135deg, var(--primary) 0%, var(--primary-dark) 100%); padding: 25px; border-radius: 16px; flex: 1; min-width: 250px; text-align: center; color: white; box-shadow: var(--card-shadow); border: 1px solid var(--gold); transition: transform 0.2s;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='none'">
            <div style="font-size: 2rem; margin-bottom: 10px;">🕌</div>
            <h3 style="font-size: 1.2rem; margin: 0 0 5px; color: var(--gold-light);">Daily Prayer Times</h3>
            <p style="font-size: 0.9rem; margin: 0; opacity: 0.9;">View exact Fajr, Zuhr, Asr, Maghrib, and Isha timings for <?php echo e($city->name); ?>.</p>
        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\ramadan\city.blade.php ENDPATH**/ ?>