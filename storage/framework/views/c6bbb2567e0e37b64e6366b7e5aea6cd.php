...
<?php $__env->startSection('title', 'Islamic Knowledge — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Explore the depths of Islamic teachings'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Islamic Knowledge','desc' => 'Explore the depths of Islamic teachings','icon' => 'fa-brain']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Islamic Knowledge','desc' => 'Explore the depths of Islamic teachings','icon' => 'fa-brain']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.module-card','data' => ['title' => ''.e($category->title ?? $category->name).'','desc' => ''.e(Str::limit($category->description ?? $category->overview ?? $category->content, 80)).'','icon' => ''.e($category->icon ?? 'fa-brain').'','url' => '#','badge' => ''.e($category->type ?? null).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($category->title ?? $category->name).'','desc' => ''.e(Str::limit($category->description ?? $category->overview ?? $category->content, 80)).'','icon' => ''.e($category->icon ?? 'fa-brain').'','url' => '#','badge' => ''.e($category->type ?? null).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
