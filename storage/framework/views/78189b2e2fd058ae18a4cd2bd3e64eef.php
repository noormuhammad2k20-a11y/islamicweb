...
<?php $__env->startSection('title', $seoMeta->title ?? 'Nawafil Prayer Times ' . $city->name); ?>
...
<section class="section hero-section" style="padding-top: 100px; padding-bottom: 50px; background: var(--gradient-hero); color: white; text-align: center;">
    <div class="section-inner">
        ...
        <h1 style="font-size: 2.5rem; margin-bottom: 15px; font-weight: 700;"><?php echo e($seoMeta->h1 ?? $city->name . ' Nawafil & Qaza Times — نوافل اوقات'); ?></h1>
        <p style="font-size: 1.1rem; color: #ddd; max-width: 600px; margin: 0 auto 30px;">
            <?php echo e(\Carbon\Carbon::now()->format('l, d F Y')); ?> <br>
        ...
        <div class="prayer-cards-grid" style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap; margin-top: 30px;">
            <div style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 15px; padding: 20px; min-width: 150px; backdrop-filter: blur(10px);">
                ...
                <div style="font-size: 1.2rem; font-weight: 700;"><?php echo e(\Carbon\Carbon::parse($todayPrayer->sunrise)->addMinutes(15)->format('h:i A')); ?></div>
            </div>
            <div style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 15px; padding: 20px; min-width: 150px; backdrop-filter: blur(10px);">
                <div style="font-size: 1.2rem; font-weight: 600; color: var(--gold); margin-bottom: 5px;">Chasht (چاشت)</div>
                <div style="font-size: 1.2rem; font-weight: 700;"><?php echo e(\Carbon\Carbon::parse($todayPrayer->sunrise)->addMinutes(45)->format('h:i A')); ?></div>
            </div>
            <div style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 15px; padding: 20px; min-width: 150px; backdrop-filter: blur(10px);">
            ...
            <div class="sidebar">
                <div class="sidebar-widget" style="background: white; padding: 25px; border-radius: 15px; box-shadow: var(--card-shadow); margin-bottom: 30px; border-top: 4px solid var(--gold);">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 10px;"><a href="<?php echo e(route('prayer-times.city', $city->slug)); ?>" style="color: var(--text-light); text-decoration: none;">Daily Fard Prayers</a></li>
                        <li style="margin-bottom: 10px;"><a href="<?php echo e(route('prayer-times.monthly', $city->slug)); ?>" style="color: var(--text-light); text-decoration: none;">Monthly Schedule</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\prayer-times\nawafil.blade.php ENDPATH**/ ?>