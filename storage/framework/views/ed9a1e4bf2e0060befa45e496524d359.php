...
<div class="faq-container" itemscope itemtype="https://schema.org/FAQPage">
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
        <button class="faq-question" aria-expanded="<?php echo e($index === 0 ? 'true' : 'false'); ?>">
            <h3 itemprop="name"><i class="fas fa-question-circle"></i> <?php echo e($faq['q']); ?></h3>
            <span class="faq-icon"><i class="fas fa-chevron-down"></i></span>
        </button>
        <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" style="<?php echo e($index === 0 ? 'display: block;' : 'display: none;'); ?>">
...
<?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\components\faq-block.blade.php ENDPATH**/ ?>