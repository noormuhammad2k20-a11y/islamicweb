...
<p><strong>Rabi' al-Thani</strong> (<?php echo e($hijri_month->name_ar); ?>), also known as Rabi' al-Akhir, is the fourth month of the Islamic Hijri calendar. Continuing the linguistic tradition of its predecessor, "Rabi" translates to spring, while "Thani" means second. This period historically marked the later part of the spring season in pre-Islamic Arabia.</p>
...
<?php echo $__env->make('pages.events.month_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\events\months\rabi-al-thani.blade.php ENDPATH**/ ?>