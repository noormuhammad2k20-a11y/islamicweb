...
<title>Umrah Checklist — Essential Packing & Prep | IslamicWeb</title>
<meta name="description" content="A comprehensive checklist for Umrah preparation, including travel documents, Ihram clothing, health essentials, and spiritual items.">
...
<section class="page-hero">
    <h1 class="page-title">Umrah Checklist</h1>
    <p class="page-subtitle">Your essential guide to packing and preparing for your blessed journey.</p>
</section>
        ...
        <div style="max-width: 1000px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 30px;">
            ...
            <div style="background: white; border-radius: 16px; padding: 30px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light); position: relative; overflow: hidden;">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0; color: #555; font-size: 1rem; line-height: 2;">
                    <li><i class="fas fa-check" style="color: var(--primary); margin-right: 10px; font-size: 0.9rem;"></i> Passport & Umrah Visa</li>
                    <li><i class="fas fa-check" style="color: var(--primary); margin-right: 10px; font-size: 0.9rem;"></i> Flight Tickets & Itinerary</li>
                    <li><i class="fas fa-check" style="color: var(--primary); margin-right: 10px; font-size: 0.9rem;"></i> Hotel Booking Confirmations</li>
            ...
            <div style="background: white; border-radius: 16px; padding: 30px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light); position: relative; overflow: hidden;">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0; color: #555; font-size: 1rem; line-height: 2;">
                    <li><i class="fas fa-check" style="color: var(--primary); margin-right: 10px; font-size: 0.9rem;"></i> 1-2 Sets of Ihram (Men)</li>
            ...
            <div style="background: white; border-radius: 16px; padding: 30px; box-shadow: var(--card-shadow); border: 1px solid var(--border-light); position: relative; overflow: hidden;">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0; color: #555; font-size: 1rem; line-height: 2;">
                    ...
                    <li><i class="fas fa-check" style="color: var(--primary); margin-right: 10px; font-size: 0.9rem;"></i> Duas Book & Umrah Guide</li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\hajj_umrah\umrah_checklist.blade.php ENDPATH**/ ?>