...
<?php $__env->startSection('title', 'Zakat Rules — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Fiqh-based explanations of Zakat calculation'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Zakat Rules','desc' => 'Fiqh-based explanations of Zakat calculation','icon' => 'fa-book-open']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Zakat Rules','desc' => 'Fiqh-based explanations of Zakat calculation','icon' => 'fa-book-open']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.module-card','data' => ['title' => ''.e($item->title ?? $item->name).'','desc' => ''.e(Str::limit($item->description ?? $item->overview ?? $item->content, 80)).'','icon' => ''.e($item->icon ?? 'fa-book-open').'','url' => '#','badge' => ''.e($item->type ?? null).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($item->title ?? $item->name).'','desc' => ''.e(Str::limit($item->description ?? $item->overview ?? $item->content, 80)).'','icon' => ''.e($item->icon ?? 'fa-book-open').'','url' => '#','badge' => ''.e($item->type ?? null).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
