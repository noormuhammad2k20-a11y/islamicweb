...
<p><strong>Jumada al-Awwal</strong> (<?php echo e($hijri_month->name_ar); ?>), sometimes referred to as Jumada al-Ula, is the fifth month in the Islamic Hijri calendar. The linguistic root of "Jumada" comes from the Arabic word for freezing or becoming solid, as this month originally coincided with the winter season when water would freeze in the Arabian Peninsula.</p>
...
<?php echo $__env->make('pages.events.month_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\events\months\jumada-al-awwal.blade.php ENDPATH**/ ?>