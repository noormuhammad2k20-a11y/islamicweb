...
<?php $__env->startSection('title', $category->name_english . ' - Duas'); ?>
...
<section class="section dua-category-section">
    <div class="section-inner">
        <div class="breadcrumb">
            <a href="<?php echo e(route('duas.index')); ?>" class="dua-back-btn">
                <i class="fas fa-arrow-left"></i> Back to Categories
            </a>
        </div>

        <div class="section-header">
            <div class="section-badge"><i class="fas <?php echo e($category->icon_class ?? 'fa-praying-hands'); ?>"></i> Category</div>
            <h1 class="section-title"><span><?php echo e($category->name_english); ?></span></h1>
            <div class="arabic-divider"><span class="line"></span><span class="symbol">﷽</span><span class="line"></span></div>
            <p class="section-subtitle"><?php echo e($category->name_urdu); ?></p>
        </div>

        <!-- OUTPUT CARD: Duas List -->
        <div class="dua-list-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $category->duas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dua): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="dua-detail-card">
                <div class="dua-title-box">
                    <div class="dua-number"><?php echo e($index + 1); ?></div>
                    <h3 class="dua-detail-title"><?php echo e($dua->title_english); ?></h3>
                </div>
                ...
                <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid var(--border-light);">
                    <span class="reference-tag"><i class="fas fa-bookmark"></i> <?php echo e($dua->reference_source); ?></span>
                </div>
  ...
  "@graph": [
    {
      ...
      "name": "<?php echo e($category->name_english); ?> Duas",
      "description": "Authentic daily duas for <?php echo e($category->name_english); ?>."
    }
  ]
}
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\duas\category.blade.php ENDPATH**/ ?>