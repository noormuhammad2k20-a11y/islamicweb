...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* Removed .mobile-toggle and .mobile-menu */
...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="navbar-inner">
            ...
            <button class="hamburger-toggle" id="hamburgerToggle" aria-label="Menu">
                <span></span><span></span><span></span>
            </button>
        </div>
    </nav>

    <!-- New Isolated Mobile Offcanvas -->
    <div class="offcanvas-backdrop" id="offcanvasBackdrop"></div>
    <div class="offcanvas-mobile" id="offcanvasMobile">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title">Noor-e-Islam</h5>
            <button class="hamburger-toggle active" id="offcanvasCloseBtn" aria-label="Close menu" style="display:flex; padding:0;">
                <span></span><span></span><span></span>
            </button>
        </div>
                    ...
                    <div>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                const prayers = <?php echo json_encode($prayerData, 15, 512) ?>;
    ...
    <script>
        ...
        // Custom Offcanvas Mobile Menu Logic
        ...
        function openOffcanvas() {
            ...
            offcanvasMobile.classList.add('show');
        ...
        if(hamburgerToggle) hamburgerToggle.addEventListener('click', openOffcanvas);
...
<?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\home.blade.php ENDPATH**/ ?>