...
<?php $__env->startSection('title', 'Privacy Policy — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Privacy Policy for Noor-e-Islam. Read about how we handle and protect your personal information.'); ?>
...
<section class="section services-section" style="padding-top: 60px;">
    <div class="section-inner">
        ...
        <div class="section-header">
            ...
            <p class="section-subtitle">Last Updated: <?php echo e(date('F d, Y')); ?></p>
        </div>
        ...
        <div class="contact-grid" style="grid-template-columns: 1fr;">
            <div class="contact-info" style="border-top: 4px solid var(--primary);">
                ...
                <p style="font-size: 1.15rem; line-height: 1.8; color: #555; margin-bottom: 20px; padding-left: 35px;">
                    If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at <a href="<?php echo e(route('contact')); ?>" style="color: var(--primary); font-weight: bold; text-decoration: none;">our contact page</a>.
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\privacy.blade.php ENDPATH**/ ?>