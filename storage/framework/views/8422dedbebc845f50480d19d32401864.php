    ...
    <div class="dua-detail-card" id="printableDua">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($dua->word_by_word_translation)): ?>
                <div style="display: flex; flex-wrap: wrap; gap: 12px; margin-top: 15px;" dir="rtl">
                    ...
                    <div style="background: var(--white); padding: 10px 18px; border-radius: var(--radius-sm); text-align: center; border: 1px solid var(--border-light);">
                        <div style="font-family: 'Scheherazade New', serif; font-size: 1.4rem; color: var(--navy);"><?php echo e($word); ?></div>
                        <div style="font-size: .8rem; color: var(--text-medium); margin-top: 4px;"><?php echo e($meaning); ?></div>
                    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dua->content_type === 'Hadith'): ?>
            ...
            <div class="content-block" style="border-left-color: #8E44AD;">
                ...
                <div class="block-text" style="font-size: .95rem;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dua->chain_of_narration): ?><p style="font-size: .85rem; opacity: .8;"><strong>Isnad:</strong> <?php echo e($dua->chain_of_narration); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php else: ?>
        ...
        <div class="content-block" style="border-left-color: var(--gold); background: var(--gold-tint);">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dua->detailed_explanation): ?>
                <p class="block-text" style="font-size: .95rem;"><?php echo nl2br(e($dua->detailed_explanation)); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dua->lessons_learned): ?>
                ...
                <p class="block-text" style="font-size: .9rem;"><?php echo nl2br(e($dua->lessons_learned)); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="tags-container">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dua->quran_reference): ?>
                <span class="tag-item"><i class="fas fa-quran" style="color: var(--navy);"></i> <?php echo e($dua->quran_reference); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="nav-buttons">
        ...
        <a href="<?php echo e(route('duas.show', ['category' => $category->slug, 'seo_slug' => $previousDua->seo_slug ?? $previousDua->id])); ?>" class="nav-btn">
            ...
            <span style="flex:1; text-align: left;">
                ...
                <span class="surah-nav-name"><?php echo e($previousDua->title_english ?? 'Dua'); ?></span>
            </span>
        </a>
        <?php else: ?>
        ...
        <a href="<?php echo e(route('duas.show', ['category' => $category->slug, 'seo_slug' => $nextDua->seo_slug ?? $nextDua->id])); ?>" class="nav-btn">
            <span style="flex:1; text-align: right;">
                ...
                <span class="surah-nav-name"><?php echo e($nextDua->title_english ?? 'Dua'); ?></span>
            </span>
...
<div style="background: var(--bg-main); padding: 1px 0;">
    <div class="section-inner related-section" style="max-width: 1140px; margin: 80px auto;">
        <h2 class="related-title">Explore More in <span><?php echo e($category->name_english); ?></span></h2>
