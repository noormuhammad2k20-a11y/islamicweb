...
<?php $__env->startSection('title', 'Zakat Nisab Thresholds — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Current Gold and Silver Nisab Values'); ?>
    ...
    <div class="section-inner">
        <div class="breadcrumb" style="text-align: center; margin-bottom: 40px;">
            <div style="background: rgba(255,255,255,0.9); padding: 10px 25px; border-radius: 50px; display: inline-block; box-shadow: 0 4px 15px rgba(0,0,0,0.05); font-size: 0.95rem;">
                ...
                <span style="color: #666; font-weight: 600;">Zakat Nisab Thresholds</span>
            </div>
        </div>

        <div class="section-header">
            <div class="section-badge"><i class="fas fa-balance-scale"></i> Feature</div>
            <h1 class="section-title">Zakat Nisab Thresholds</h1>
            <div class="arabic-divider"><span class="line"></span><span class="symbol">﷽</span><span class="line"></span></div>
            <p class="section-subtitle">Current Gold and Silver Nisab Values</p>
        </div>
        ...
        <div class="contact-grid" style="grid-template-columns: 1fr;">
            <div class="contact-info" style="border-top: 4px solid var(--primary); background: #fff; padding: 40px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
                ...
                <div style="text-align:center; padding: 50px 0;">
                    <i class="fas fa-balance-scale" style="font-size: 4rem; color: var(--gold); opacity: 0.5; margin-bottom: 20px;"></i>
                    ...
                    <p style="color: #666; font-size: 1.1rem; max-width: 600px; margin: 0 auto;">
                        This section has been scaffolded and integrated with the Laravel routing system. The dynamic content for <strong>Zakat Nisab Thresholds</strong> will be populated here.
                    </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views/pages/zakat/nisab.blade.php ENDPATH**/ ?>