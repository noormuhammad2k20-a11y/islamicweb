...
<?php $__env->startSection('title', $name->transliteration . ' (' . $name->arabic . ') - 99 Names of Allah'); ?>
<?php $__env->startSection('meta_description', 'Learn the meaning, benefits, and explanation of ' . $name->transliteration . ' (' . $name->arabic . '), one of the 99 Names of Allah.'); ?>
...
<div class="page-header print-area" style="background: var(--primary); color: white; padding: 60px 0; text-align: center;">
    <div class="container">
        <nav aria-label="Breadcrumb" class="no-print" style="margin-bottom: 20px;">
            <ol typeof="BreadcrumbList" vocab="https://schema.org/" style="list-style: none; padding: 0; display: inline-flex; gap: 10px; font-size: 0.9rem; opacity: 0.8;">
                <li property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" href="<?php echo e(route('names_allah.index')); ?>" style="color: white; text-decoration: none;"><span property="name">99 Names of Allah</span></a>
                    <meta property="position" content="1"/>
                </li>
                <li>></li>
                <li property="itemListElement" typeof="ListItem">
                    <span property="name"><?php echo e($name->transliteration); ?></span>
                    <meta property="position" content="2"/>
                </li>
            </ol>
        </nav>

        <div style="font-size: 1.2rem; margin-bottom: 15px; opacity: 0.8;">Name #<?php echo e($name->number); ?></div>
        ...
        <h2 style="color: white; margin-bottom: 10px;"><?php echo e($name->transliteration); ?></h2>
        <p style="opacity: 0.9; margin-bottom: 20px; font-size: 1.2rem;"><?php echo e($name->meaning_english); ?></p>
        ...
        <div class="no-print" style="display: flex; gap: 15px; justify-content: center;">
            ...
            <button onclick="navigator.clipboard.writeText('<?php echo e(url()->current()); ?>'); alert('Link copied!');" style="background: rgba(255,255,255,0.2); border: none; color: white; border-radius: 20px; padding: 5px 15px; cursor: pointer;">
        ...
        <div class="col-md-8" style="flex: 2; min-width: 300px;">
            ...
            <div style="background: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); padding: 40px; margin-bottom: 30px;" class="no-print">
                ...
                function playPronunciation() {
                    if ('speechSynthesis' in window) {
                        ...
                        let utterance = new SpeechSynthesisUtterance("<?php echo e($name->arabic); ?>");
            ...
            <div style="background: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); padding: 40px; margin-bottom: 30px;">
                ...
                <div style="font-size: 1.15rem; color: var(--text-dark); line-height: 1.8;">
                    <?php echo nl2br(e($name->benefits)); ?>

                </div>
            </div>
            
            <a href="<?php echo e(route('names_allah.index')); ?>" class="btn-outline-primary no-print" style="display: inline-flex; align-items: center; gap: 10px;">
            ...
            <div style="background: var(--secondary-light); border-radius: 12px; padding: 30px; margin-bottom: 30px;">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="margin-bottom: 15px; border-bottom: 1px solid rgba(10, 58, 42,0.1); padding-bottom: 10px;">
                        ...
                        <span lang="ar" dir="rtl" style="color: var(--gold); font-size: 1.8rem; font-family: 'Amiri', serif;"><?php echo e($name->arabic); ?></span>
                    </li>
                    <li style="margin-bottom: 15px; border-bottom: 1px solid rgba(10, 58, 42,0.1); padding-bottom: 10px;">
                        <span style="font-weight: 600; color: var(--text-dark); display: block;">English:</span>
                        <span style="color: var(--text-light);"><?php echo e($name->meaning_english); ?></span>
                    </li>
                    <li style="margin-bottom: 15px;">
                        <span style="font-weight: 600; color: var(--text-dark); display: block;">Urdu:</span>
                        <span lang="ur" dir="rtl" style="color: var(--text-light); font-family: 'Jameel Noori Nastaleeq', 'Noto Naskh Arabic', serif; font-size: 1.4rem;"><?php echo e($name->meaning_urdu); ?></span>
                    </li>
                </ul>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\Islamicwebsite\resources\views\pages\allah_names\show.blade.php ENDPATH**/ ?>