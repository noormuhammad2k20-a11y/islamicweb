...
<?php $__env->startSection('title', 'Prayer Guide — Noor-e-Islam'); ?>
<?php $__env->startSection('meta_description', 'Detailed guide for specific prayer'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Prayer Guide','desc' => 'Detailed guide for specific prayer','icon' => 'fa-book-open']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Prayer Guide','desc' => 'Detailed guide for specific prayer','icon' => 'fa-book-open']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.module-card','data' => ['title' => ''.e($guide->title ?? $guide->name).'','desc' => ''.e(Str::limit($guide->description ?? $guide->overview ?? $guide->content, 80)).'','icon' => ''.e($guide->icon ?? 'fa-book-open').'','url' => '#','badge' => ''.e($guide->type ?? null).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($guide->title ?? $guide->name).'','desc' => ''.e(Str::limit($guide->description ?? $guide->overview ?? $guide->content, 80)).'','icon' => ''.e($guide->icon ?? 'fa-book-open').'','url' => '#','badge' => ''.e($guide->type ?? null).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
